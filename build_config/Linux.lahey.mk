# $Id: Linux.lahey.mk,v 1.1 2003/08/26 17:40:16 flanigan Exp $
#
# Linux.default.longs_lahey
#
#
...
.F90.o:
	${FC} -c ${C_FC_MOD}${ESMC_MODDIR} ${FOPTFLAGS} ${FFLAGS} ${FCPPFLAGS} -Cpp --nfix ${ESMC_INCLUDE} $<

.F.o:
	${FC} -c ${C_FC_MOD}${ESMC_MODDIR} ${FOPTFLAGS} ${FFLAGS} --nfix ${ESMC_INCLUDE} $<
