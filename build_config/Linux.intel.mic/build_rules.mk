# $Id: build_rules.mk,v 1.60.2.11 2008/12/05 20:17:25 theurich Exp $
#
# Linux.intel.default
#
...
#
ESMF_F90DEFAULT         = ifort -mmic -auto
ESMF_CXXDEFAULT         = icpc -mmic
...
# IntelMPI -------------------------------------------------
ESMF_F90DEFAULT         = mpiifort -mmic -auto -Bstatic
ESMF_CXXDEFAULT         = mpiicpc -mmic -Bstatic
ESMF_MPIRUNDEFAULT      = mpirun $(ESMF_MPILAUNCHOPTIONS)
ESMF_MPIMPMDRUNDEFAULT  = mpiexec $(ESMF_MPILAUNCHOPTIONS)
else
