# $Id: build_rules.mk,v 1.1.2.6 2008/01/29 18:38:25 svasquez Exp $
#
# Unicos.pgi.default
#
...
ESMF_F90LINKLIBS       += 
ESMF_CXXLINKLIBS       += 
ESMF_MPIRUNDEFAULT      = $(ESMF_DIR)/scripts/mpirun.yod
ifeq ($(ESMF_BATCH),xt3.batch)
ESMF_MPIRUNDEFAULT      = $(ESMF_DIR)/scripts/mpirun.xt3.batch
endif
