...
ESMF_TRACE_WRAPPERS_MPI += MPI_Gather MPI_Gatherv MPI_Probe MPI_Recv
ESMF_TRACE_WRAPPERS_MPI += MPI_Reduce MPI_Scatter MPI_Send MPI_Sendrecv
ESMF_TRACE_WRAPPERS_MPI += MPI_Wait MPI_Waitall MPI_Waitany MPI_Waitsome
...
ESMF_TRACE_WRAPPERS_MPI += mpi_gatherv_ mpi_gatherv__ mpi_probe_ mpi_probe__
ESMF_TRACE_WRAPPERS_MPI += mpi_recv_ mpi_recv__ mpi_reduce_ mpi_reduce__
ESMF_TRACE_WRAPPERS_MPI += mpi_reduce_scatter_ mpi_reduce_scatter__ mpi_scatter_ mpi_scatter__
ESMF_TRACE_WRAPPERS_MPI += mpi_scatterv_ mpi_scatterv__ mpi_scan_ mpi_scan__
ESMF_TRACE_WRAPPERS_MPI += mpi_send_ mpi_send__ mpi_wait_ mpi_wait__
