%  $Id: ESMF_builddetail.tex,v 1.11 2004/06/22 14:19:04 nscollins Exp $
...
There are eight other variables that the build system uses.  If they
...
or 64.  When possible the default value will be 64, otherwise it will be 32.
