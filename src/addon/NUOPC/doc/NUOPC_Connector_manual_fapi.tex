...
\item phase 0: ({\sc Required, NUOPC Provided})
  \begin{itemize}
  \item Initialize the {\tt InitializePhaseMap} Attribute according to the NUOPC Initialize Phase Definition (IPD) version 01 (see section \ref{IPD} for a precise definition), with the following mapping:
    \begin{itemize}
    ...
    \end{itemize}  
  \end{itemize}  
\item phase 1: ({\sc NUOPC Provided}, suitable for: IPDv01p1, IPDv02p1)
  \begin{itemize}
  ...
  \end{itemize}
\item phase 2: ({\sc NUOPC Provided}, suitable for: IPDv01p2, IPDv02p2)
  \begin{itemize}
  ...
  \end{itemize}  
\item phase 3: ({\sc NUOPC Provided}, suitable for: IPDv01p3, IPDv02p3)
  \begin{itemize}
  \item Use the {\tt CplList} attribute to construct {\tt srcFields} and {\tt dstFields} FieldBundles in the internal state that hold matched Field pairs.
  \item Set the {\tt Connected} attribute to {\tt true} in the Field metadata for each Field that is added to the {\tt srcFields} and {\tt dstFields} FieldBundles.
