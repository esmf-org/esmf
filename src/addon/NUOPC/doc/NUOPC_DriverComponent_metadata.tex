...
\begin{longtable}{|p{.25\textwidth}|p{.4\textwidth}|p{.4\textwidth}|}
     ...
     {\tt HierarchyConnectors} & String value specifying how hierarchy connectors are created.& "auto" (default), all of the connectors needed by "HierarchyProtocol" are created automatically. "manual", only connectors created manually will be used.\\ \hline
     \hline
\end{longtable}
