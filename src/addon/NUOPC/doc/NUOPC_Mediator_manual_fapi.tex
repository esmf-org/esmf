...
\begin{itemize}
  ...
  \begin{itemize}
    ...
    \begin{itemize}
      \item Optional. By default timestamp all export fields according to the current time of the component internal clock at the {\em beginning} of the Advance step.
    \end{itemize}
  \end{itemize}
  \item Finalize:
  \begin{itemize}
