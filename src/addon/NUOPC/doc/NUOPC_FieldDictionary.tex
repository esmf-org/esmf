...
The {\tt StandardName} Attributes of all the currently implemented entries in the dictionary comply with the Climate and Forecast (CF) conventions as documented at \htmladdnormallink{http://cf-pcmdi.llnl.gov/}{http://cf-pcmdi.llnl.gov/}.
