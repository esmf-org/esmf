...
\htmladdnormallink{NUOPC Layer}{https://www.earthsystemcog.org/projects/nuopc/} is
a software layer built on top of the
\htmladdnormallink{Earth System Modeling Framework}{https://www.earthsystemcog.org/projects/esmf/} (ESMF).
...
resources available:
\begin{itemize}
\item \htmladdnormallink{The NUOPC website}{https://www.earthsystemcog.org/projects/nuopc}
is the main source of information on NUOPC, including instructions
for acquiring and using the NUOPC Layer software.

\item \htmladdnormallink{The NUOPC Reference Manual}{https://www.earthsystemcog.org/projects/nuopc/refmans}
is the primary technical reference for the NUOPC API and includes
a detailed description of the NUOPC generic components.

\item \htmladdnormallink{The NUOPC Prototype Codes page}{https://www.earthsystemcog.org/projects/nuopc/proto\_codes}
and \htmladdnormallink{Subversion repository}{https://sourceforge.net/p/esmfcontrib/svn/HEAD/tree/NUOPC/tags/ESMF\_7\_0\_0/}
...
\item Several \htmladdnormallink{Compliance Testing Tools}{https://www.earthsystemcog.org/projects/nuopc/compliance\_testing}
are provided to help you test your code to determine if it is NUOPC Layer compliant.

\item \htmladdnormallink{Cupid}{https://www.earthsystemcog.org/projects/cupid/}
