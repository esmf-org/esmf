...
\begin{tabular}{|p{4cm}|p{5cm}|p{1cm}|p{35mm}|}
     ...
     {\tt regridmethod} & Interpolation method used to compute the regridding weights.& single & {\tt bilinear}(default), {\tt patch}, {\tt nearest\_stod}, {\tt nearest\_dtos}, {\tt conserve}\\ \hline
