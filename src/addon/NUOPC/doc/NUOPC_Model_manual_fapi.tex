...
\subsubsection{Initialize Phase Specialization - SetClock}
...
\subsubsection{Initialize Phase Specialization - DataInitialize}
{\sc Optional, Implementor Provided}\\
...
\subsubsection{Run Phase Specialization - SetRunClock}
...
\subsubsection{Run Phase Specialization - CheckImport}
{\sc Required, NUOPC Provided}\\
{\em Called from: default run phase}\\
...
\subsubsection{Run Phase Specialization - Advance}
...
\subsubsection{Run Phase Specialization - TimestampExport}
{\sc Required, NUOPC Provided}\\
{\em Called from: default run phase}\\
...
\subsubsection{Finalize Phase Specialization - Finalize}
{\sc Optional, Implementor Provided}\\
