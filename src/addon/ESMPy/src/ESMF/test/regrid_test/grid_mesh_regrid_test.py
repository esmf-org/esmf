...
"""
This test demonstrates bilinear regridding between a grid and mesh.
...
compare_fields_grid(dstfield, exactfield, 40E-2, 10E-16, parallel=parallel, regrid_method=ESMF.RegridMethod.BILINEAR)
