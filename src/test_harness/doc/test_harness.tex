...
periodic & periodic function of the grid coordinates & phases k and l, relative error \\
pulse &  a gaussian pulse centered at the origin & width, relative error \\
\hline 
\end{tabular}
\end{center}
