...
!   !  The Negotiation routine
  ...
  subroutine user_neg_routine(comp, rc)
    ...
    print *, "USER: Hello world: User negotiation routine (user model 1) !"
...
!   !   private to the module.
  ...
  subroutine user_setvm(comp, rc)
    ...
    subroutine user_register(comp, rc)
        ...
        print *, "In user register routine (user model 1)"
...
!   !   first Initialization routine.
    ...
    subroutine user_init1(comp, importState, exportState, clock, rc)
        ...
        print *, "first init routine called (user model 1)"
...
!     ! Local variables
        ...
        print *, "User Comp Init 2 starting (user model 1)"
...
!   !
    ...
    subroutine user_run(comp, importState, exportState, clock, rc)
        ...
        print *, "User Comp Run starting (user model 1)"
...
!     ! Local variables
        ...
        print *, "User Comp Final starting (user model 1)"
