! $Id: user_model3.F90,v 1.3 2009/03/20 19:49:45 svasquez Exp $
!
...
!   !   private to the module.
  ...
  subroutine userm3_register(comp, rc)
    ...
    print *, "User Comp3 Register starting"
    ...
    print *, "User Comp3 Register returning"
...
!   !   Initialization routine.
  ...
  subroutine user_init(comp, importState, exportState, clock, rc)
    ...
    print *, "User Comp3 Init starting"
...
!   !
  ...
  subroutine user_final(comp, importState, exportState, clock, rc)
    ...
    print *, "User Comp3 Final starting"
    ...
    print *, "User Comp3 Final returning"
