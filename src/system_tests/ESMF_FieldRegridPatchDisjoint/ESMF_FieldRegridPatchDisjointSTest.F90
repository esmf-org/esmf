...
!\begin{verbatim}
    ...
    program ESMF_FieldRegridPatchDisjointSTest
#define ESMF_METHOD "program ESMF_FieldRegridPatchDisjointSTest"
...
!-------------------------------------------------------------------------
    ...
    print *, "-------------------------------- "
    print *, "Start of System Test ESMF_FieldRegridPatchDisjointSTest:"
    print *, "-------------------------------- "
...
!
    ...
    if ( npets < 5 ) then
       call ESMF_LogSetError(ESMF_RC_ARG_BAD,&
           msg="This system test does not run on fewer than 5 PETs.",&
           ESMF_CONTEXT, rcToReturn=rc)
    ...
    cname2 = "user model 2"
    comp2 = ESMF_GridCompCreate(name=cname2, petList=(/1,2,3,4/),rc=localrc)
    if (ESMF_LogFoundError(localrc, ESMF_ERR_PASSTHRU, &
      ESMF_CONTEXT, rcToReturn=rc)) &
      call ESMF_Finalize(endflag=ESMF_END_ABORT)
...
10  print *, "System Test FieldRegridMeshToMesh complete."
    ...
    end program ESMF_FieldRegridPatchDisjointSTest
