! $Id$
!
! System test code FieldBundleLSRedistArb2Arb
...
!
! !DESCRIPTION:
! System test FieldBundleLSRedistArb2Arb.
...
!                 values and then transformed to the second 
!                 component through the FieldBundleRedist operation.
!                 The destination field builds upon a location
!                 stream with a different distribution. The
!                 transformed data is then compared to predetermined
!                 result.
!
!\begin{verbatim}

    program ESMF_FieldBundleLSRedistArb2ArbSTest
#define ESMF_METHOD "program ESMF_FieldBundleLSRedistArb2ArbSTest"
...
!-------------------------------------------------------------------------
    ...
    print *, "------------------------------------------------ "
    print *, "Start of System Test FieldBundleLSRedistArb2Arb:"
    print *, "------------------------------------------------ "
...
!
    ...
    call ESMF_Initialize(vm=vm, defaultlogfilename="FieldBundleLSRedistArb2ArbSTest.Log", &
...
!-------------------------------------------------------------------------
!-------------------------------------------------------------------------
10  print *, "System Test FieldBundleLSRedistArb2Arb complete."


    ! Normal ESMF Test output
    write(failMsg, *) "System Test failure"
    write(testname, *) "System Test FieldBundleLSRedistArb2Arb: LocStream based FieldBundleRedist"
    ...
    end program ESMF_FieldBundleLSRedistArb2ArbSTest
