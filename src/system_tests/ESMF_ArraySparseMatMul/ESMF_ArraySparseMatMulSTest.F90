! $Id: ESMF_ArraySparseMatMulSTest.F90,v 1.3 2006/05/19 21:35:53 theurich Exp $
!
!-------------------------------------------------------------------------
...
!-------------------------------------------------------------------------
  ...
  if (rc .ne. ESMF_SUCCESS) goto 10
  call ESMF_GridCompInitialize(comp1, exportState=c1exp, clock=dummyclk, rc=rc)
  print *, "Comp 1 Initialize finished, rc =", rc
  if (rc .ne. ESMF_SUCCESS) goto 10
 
  c2imp = ESMF_StateCreate("comp2 import", ESMF_STATE_IMPORT, rc=rc)
  if (rc .ne. ESMF_SUCCESS) goto 10
  call ESMF_GridCompInitialize(comp2, importState=c2imp, clock=dummyclk, rc=rc)
  ...
  call ESMF_CplCompInitialize(cpl, c1exp, c2imp, clock=dummyclk, rc=rc)
...
!-------------------------------------------------------------------------
  ...
  call ESMF_GridCompRun(comp1, exportState=c1exp, clock=dummyclk, rc=rc)
  print *, "Comp 1 Run returned, rc =", rc
  if (rc .ne. ESMF_SUCCESS) goto 10

  call ESMF_CplCompRun(cpl, c1exp, c2imp, clock=dummyclk, rc=rc)
  print *, "Coupler Run returned, rc =", rc
  if (rc .ne. ESMF_SUCCESS) goto 10

  call ESMF_GridCompRun(comp2, importState=c2imp, clock=dummyclk, rc=rc)
...
!-------------------------------------------------------------------------
  ...
  call ESMF_GridCompFinalize(comp1, exportState=c1exp, clock=dummyclk, rc=rc)
  print *, "Comp 1 Finalize finished, rc =", rc
  if (rc .ne. ESMF_SUCCESS) goto 10

  call ESMF_GridCompFinalize(comp2, importState=c2imp, clock=dummyclk, rc=rc)
  print *, "Comp 2 Finalize finished, rc =", rc
  if (rc .ne. ESMF_SUCCESS) goto 10

  call ESMF_CplCompFinalize(cpl, c1exp, c2imp, clock=dummyclk, rc=rc)
