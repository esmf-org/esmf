! $Id: ESMF_ArraySparseMatMulSTest.F90,v 1.11.2.4 2008/05/07 20:30:26 theurich Exp $
!
!-------------------------------------------------------------------------
...
program ESMF_ArraySparseMatMulSTest
#define ESMF_METHOD "program ESMF_ArraySparseMatMulSTest"
...
!-------------------------------------------------------------------------
  ...
  write(testname, *) "System Test ESMF_ArraySparseMatMulSTest"
