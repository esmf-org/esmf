! $Id: ESMF_Blk2ArbBunRedistSTest.F90,v 1.1.2.2 2006/08/29 21:44:05 samsoncheung Exp $
!
! System test ESMF_BundleBlk2ArbRedist
...
!
! !DESCRIPTION:
! System test BundleBlk2ArbRedist.
!
...
!-------------------------------------------------------------------------
     ...
     print *, "System Test BundleBlk2ArbRedist."
!
!-------------------------------------------------------------------------
!-------------------------------------------------------------------------
!  Create section
...
!-------------------------------------------------------------------------
!-------------------------------------------------------------------------
20    print *, "System Test BundleBlk2ArbRedist complete."

    if ((myPet .eq. 0) .or. (status .ne. ESMF_SUCCESS)) then
      write(failMsg, *)  "Redistribution back not same as original"
      write(testname, *) "System Test BundleBk2ArbRedist: Bundle Redistribute"
