...
program ESMF_ShareGridSTest
#define ESMF_METHOD "program ESMF_ShareGridSTest"
...
!-------------------------------------------------------------------------
  ...
  write(testname, *) "System Test ESMF_ShareGridSTest"
...
!
  ...
  call ESMF_Initialize(vm=vm, &
    defaultlogfilename="ShareGridSTest.Log", &
...
end program ESMF_ShareGridSTest
