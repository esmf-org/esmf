! $Id: ESMF_Blk2BlkFldRedistSTest.F90,v 1.1.2.2 2006/08/29 21:46:44 samsoncheung Exp $
!
! System test ESMF_FieldBlk2BlkRedist
...
!
! !DESCRIPTION:
! System test FieldBlk2BlkRedist.
!
...
!-------------------------------------------------------------------------
     ...
     print *, "System Test FieldBlk2BlkRedist."
!
!-------------------------------------------------------------------------
!-------------------------------------------------------------------------
!  Create section
...
!-------------------------------------------------------------------------
!-------------------------------------------------------------------------
20    print *, "System Test FieldBlk2BlkRedist complete."

    if ((myPet .eq. 0) .or. (status .ne. ESMF_SUCCESS)) then
      write(failMsg, *)  "Redistribution back not same as original"
      write(testname, *) "System Test FieldBlk2BlkRedist: Field Redistribute"
