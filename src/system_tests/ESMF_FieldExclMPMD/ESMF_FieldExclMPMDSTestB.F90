! $Id: ESMF_FieldExclMPMDSTestB.F90,v 1.10 2008/11/14 04:39:16 theurich Exp $
!
...
!-------------------------------------------------------------------------
!ESMF_SYSTEM______TEST_DISABLED        String used by test script to count system tests.
