! $Id: ESMF_FieldExclMPMDSTestA.F90,v 1.5 2007/06/22 23:21:55 cdeluca Exp $
!
...
!
    ...
    cname1 = "user model 1"
    comp1 = ESMF_InternGridCompCreate(name=cname1, &
    ...
    cname2 = "user model 2"
    comp2 = ESMF_InternGridCompCreate(name=cname2, &
                                petList=(/ 5,1,3 /), rc=rc)
    if (rc .ne. ESMF_SUCCESS) goto 10
