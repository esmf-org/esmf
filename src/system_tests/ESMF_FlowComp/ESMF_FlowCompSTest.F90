! $Id: ESMF_FlowCompSTest.F90,v 1.24 2007/06/23 04:01:32 cdeluca Exp $
!
...
!-------------------------------------------------------------------------
!-------------------------------------------------------------------------
      call ESMF_IGridCompSetServices(comp1, FlowMod_register, rc)
      if (rc .ne. ESMF_SUCCESS) goto 10
...
!-------------------------------------------------------------------------
      ...
      if (rc .ne. ESMF_SUCCESS) goto 10
      call ESMF_IGridCompInitialize(comp1, exportState=c1exp, clock=clock, &
                                   rc=rc)
      if (rc .ne. ESMF_SUCCESS) goto 10
