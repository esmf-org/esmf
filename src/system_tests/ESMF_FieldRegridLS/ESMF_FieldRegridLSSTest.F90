! $Id$
!
! System test code FieldRegridLS
...
!
! !DESCRIPTION:
! System test FieldRegridLS.
!   Field Regrid test.  2 components and 1 coupler, one-way coupling.
!                 The first component has a location stream with
!                 a Field whose data is set to lon/360.0.
!                 The second component contains a destination Field
!                 built upon a slightly offset location stream. The coupler component 
!                 regrids data (using nearest neighbor) from the first component to the second. 
!                 In the second component the data is then compared
!                 to an analytic value to ensure that the operation occurred successfully. 
!
!\begin{verbatim}

    program ESMF_FieldRegridLSSTest
#define ESMF_METHOD "program ESMF_FieldRegridLSSTest"
...
!-------------------------------------------------------------------------
    ...
    print *, "-------------------------------- "
    print *, "Start of System Test FieldRegridLS:"
    print *, "-------------------------------- "
...
!
    ...
    call ESMF_Initialize(vm=vm, defaultlogfilename="FieldRegridLSSTest.Log", &
...
!-------------------------------------------------------------------------
!-------------------------------------------------------------------------
10  print *, "System Test FieldRegridLS complete."


    ! Normal ESMF Test output
    write(failMsg, *) "System Test failure"
    write(testname, *) "System Test FieldRegridLS: LocStream based Field Regrid"

    if (rc .ne. ESMF_SUCCESS) then
      ! Separate message to console, for quick confirmation of success/failure
      if (rc .eq. ESMF_SUCCESS) then
        write(finalMsg, *) "SUCCESS: LocStream based Field Regrid test finished correctly."
      else
    ...
    end program ESMF_FieldRegridLSSTest
