! $Id: ESMF_FieldLSSMMSTest.F90,v 1.16 2011/03/25 22:31:26 svasquez Exp $
!
...
!\begin{verbatim}
    ...
    program ESMF_FieldLSSMMSTest
#define ESMF_METHOD "program ESMF_FieldLSSMMSTest"
...
!-------------------------------------------------------------------------
    ...
    print *, "-------------------------------- "
    print *, "Start of System Test FieldLSSMM:"
    print *, "-------------------------------- "
...
!-------------------------------------------------------------------------
!-------------------------------------------------------------------------
10  print *, "System Test FieldLSSMM complete."


    ! Normal ESMF Test output
    write(failMsg, *) "System Test failure"
    write(testname, *) "System Test FieldLSSMM: LocStream based Field SMM"

    if (rc .ne. ESMF_SUCCESS) then
      ! Separate message to console, for quick confirmation of success/failure
      if (rc .eq. ESMF_SUCCESS) then
        write(finalMsg, *) "SUCCESS: LocStream based Field SMM test finished correctly."
      else
