! $Id$
!
! System test CompCreateTwoConcurrentAccWithResNeg
...
!\begin{verbatim}
    ...
    program CompCreateTwoConcurrentAccWithResNeg
...
!-------------------------------------------------------------------------
    ...
    print *, "System Test CompCreateTwoConcurrentAccWithResNeg:"
...
!
    ...
    call ESMF_Initialize(defaultlogfilename="CompCreateTwoConcurrentAccWithResNegSTest.Log", &
    ...
    cnames(1) = "System Test CompCreateTwoConcurrentAccWithResNeg Comp 1"
    ...
    cnames(2) = "System Test CompCreateTwoConcurrentAccWithResNeg Comp 2"
...
!-------------------------------------------------------------------------
 ...
 10   print *, "System Test CompCreateTwoConcurrentAccWithResNeg complete"

      ! Standard ESMF Test output to log file
      write(failMsg, *) "System Test failure"
      write(testname, *) "System Test CompCreateTwoConcurrentAccWithResNeg: Component Create Test"
      ...
      end program CompCreateTwoConcurrentAccWithResNeg
