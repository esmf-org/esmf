...
!\begin{verbatim}
    ...
    use user_model, only : user_neg_routine, user_setvm, user_register
...
!
    ...
    !comp1 = ESMF_GridCompCreate(name=cname, userNegRoutine=user_neg_routine, rc=rc)
...
!-------------------------------------------------------------------------
!-------------------------------------------------------------------------
      call ESMF_GridCompSetUserNegRoutine(comp1, userNegRoutine=user_neg_routine, &
        rc=rc)
      if (rc .ne. ESMF_SUCCESS) goto 10
      print *, "Comp SetUserNegRoutine finished, rc= ", rc
