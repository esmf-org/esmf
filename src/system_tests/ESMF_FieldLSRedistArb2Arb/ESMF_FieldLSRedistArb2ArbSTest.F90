! $Id$
!
! System test code FieldLSRedistArb2Arb
...
!\begin{verbatim}
    ...
    program ESMF_FieldLSRedistArb2ArbSTest
#define ESMF_METHOD "program ESMF_FieldLSRedistArb2ArbSTest"
...
!-------------------------------------------------------------------------
    ...
    print *, "------------------------------------------ "
    print *, "Start of System Test FieldLSRedistArb2Arb:"
    print *, "------------------------------------------ "
...
!
    ...
    call ESMF_Initialize(vm=vm, defaultlogfilename="FieldLSRedistArb2ArbSTest.Log", &
...
!-------------------------------------------------------------------------
!-------------------------------------------------------------------------
10  print *, "System Test FieldLSRedistArb2Arb complete."


    ! Normal ESMF Test output
    write(failMsg, *) "System Test failure"
    write(testname, *) "System Test FieldLSRedistArb2Arb: LocStream based FieldRedist"
    ...
    end program ESMF_FieldLSRedistArb2ArbSTest
