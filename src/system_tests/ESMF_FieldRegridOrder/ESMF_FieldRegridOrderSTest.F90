! $Id: ESMF_FieldRegridOrderSTest.F90,v 1.28 2011/02/22 15:49:34 rokuingh Exp $
!
...
!                 The index orders of the igrids are not the same.
...
!-------------------------------------------------------------------------
    ...
    clock = ESMF_ClockCreate(timeStep, startTime, stopTime, "Clock 1", rc=rc)
    if (rc .ne. ESMF_SUCCESS) goto 10
...
10  print *, "System Test FieldRegridOrder complete."
    ...
    write(testname, *) "System Test FieldRegridOrder: Field Regrid w/ different IGrid Orders"
