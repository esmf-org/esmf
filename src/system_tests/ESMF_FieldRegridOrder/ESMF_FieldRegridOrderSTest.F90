! $Id: ESMF_FieldRegridOrderSTest.F90,v 1.9.4.2 2005/03/03 22:21:18 nscollins Exp $
!
...
10    print *, "System Test FieldRegridOrder complete."
    ...
    if ((pet_id .eq. 0) .or. (rc .ne. ESMF_SUCCESS)) then
      ...
      write(testname, *) "System Test FieldRegridOrder: Field Regrid w/ different Grid Orders"
