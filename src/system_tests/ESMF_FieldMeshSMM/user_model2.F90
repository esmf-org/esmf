! $Id: user_model2.F90,v 1.2 2009/08/03 19:59:59 theurich Exp $
!
...
!   ! Local variables
      ...
      call ESMF_FieldGet(humidity, localDe=0, farray=dstfptr, rc=rc)
      if(rc/=ESMF_SUCCESS) return
...
!   ! Local variables
      ...
      call ESMF_FieldGet(humidity, localDe=0, farray=fptr, &
