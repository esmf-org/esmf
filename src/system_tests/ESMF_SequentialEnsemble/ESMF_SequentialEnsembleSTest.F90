...
!
! !DESCRIPTION:
! System test ESMF_SequentialEnsemble
...
program ESMF_SequentialEnsemble
...
!-------------------------------------------------------------------------
  ...
  print *, "--------------------------------------- "
  print *, "Start of System Test SequentialEnsemble: "
  print *, "--------------------------------------- "
...
10 continue
  print *, "System Test ESMF_SequentialEnsemble complete."
...
end program ESMF_SequentialEnsemble
