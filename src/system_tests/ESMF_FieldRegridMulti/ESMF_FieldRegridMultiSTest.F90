! $Id: ESMF_FieldRegridMultiSTest.F90,v 1.19 2007/06/22 23:21:57 cdeluca Exp $
!
...
!   Regrid test with a 2D interngrid and a 3D data field, where the 3rd dimension
!                 is multiple values corresponding to the same interngrid cell.
!
