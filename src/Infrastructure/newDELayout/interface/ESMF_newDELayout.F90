...
! !PUBLIC MEMBER FUNCTIONS:
  ...
  ! - ESMF_newDELayout:
      ...
      public ESMF_newDELayoutCopyCopy
...
!------------------------------------------------------------------------------
!BOPI
! !IROUTINE: ESMF_newDELayoutCopyCopy -- Generic interface

! !INTERFACE:
      interface ESMF_newDELayoutCopyCopy

! !PRIVATE MEMBER FUNCTIONS:
!
      module procedure ESMF_newDELayoutCopyCopyGeneral
      module procedure ESMF_newDELayoutCopyCopyI4
      module procedure ESMF_newDELayoutCopyCopyR4
      module procedure ESMF_newDELayoutCopyCopyR8
...
! !PRIVATE MEMBER FUNCTIONS:
!
      module procedure ESMF_newDELayoutGlobReduceGenI4
      module procedure ESMF_newDELayoutGlobReduceGenR4
      module procedure ESMF_newDELayoutGlobReduceGenR8
      module procedure ESMF_newDELayoutGlobReduceI4
      module procedure ESMF_newDELayoutGlobReduceR4
      module procedure ESMF_newDELayoutGlobReduceR8
...
! !INTERFACE:
  ...
  subroutine ESMF_newDELayoutCopyCopyGeneral(delayout, srcData1, srcData2, &
...
! !REQUIREMENTS:  SSSn.n, GGGn.n
  ...
  end subroutine ESMF_newDELayoutCopyCopyGeneral
!------------------------------------------------------------------------------
...
! !INTERFACE:
  ...
  subroutine ESMF_newDELayoutGlobReduceGenI4(delayout, srcData, &
...
! !REQUIREMENTS:  SSSn.n, GGGn.n
  ...
  end subroutine ESMF_newDELayoutGlobReduceGenI4
!------------------------------------------------------------------------------
...
! !INTERFACE:
  ! Private name; call using ESMF_newDELayoutAllGlobalReduce()
  subroutine ESMF_newDELayoutGlobReduceGenR4(delayout, srcData, &
    dstData, count, operation, blockingFlag, commHandle, rc)
!
! !ARGUMENTS:
    type(ESMF_newDELayout),        intent(in)            :: delayout
...
! !REQUIREMENTS:  SSSn.n, GGGn.n
  ...
  end subroutine ESMF_newDELayoutGlobReduceGenR4
!------------------------------------------------------------------------------
...
! !INTERFACE:
  ! Private name; call using ESMF_newDELayoutAllGlobalReduce()
  subroutine ESMF_newDELayoutGlobReduceGenR8(delayout, srcData, &
    dstData, count, operation,  blockingFlag, commHandle, rc)
!
! !ARGUMENTS:
    type(ESMF_newDELayout),        intent(in)            :: delayout
...
! !REQUIREMENTS:  SSSn.n, GGGn.n
  ...
  end subroutine ESMF_newDELayoutGlobReduceGenR8
!------------------------------------------------------------------------------
...
! !INTERFACE:
  ! Private name; call using ESMF_newDELayoutCopyCopy()
  subroutine ESMF_newDELayoutCopyCopyI4(delayout, srcData1, srcData2, &
    dstData1, dstData2, count1, count2, de1, de2, blockingFlag, commHandle, rc)
!
! !ARGUMENTS:
    type(ESMF_newDELayout),        intent(in)            :: delayout
...
! !REQUIREMENTS:  SSSn.n, GGGn.n
  ...
  end subroutine ESMF_newDELayoutCopyCopyI4
!------------------------------------------------------------------------------
...
! !INTERFACE:
  ! Private name; call using ESMF_newDELayoutCopyCopy()
  subroutine ESMF_newDELayoutCopyCopyR4(delayout, srcData1, srcData2, &
    dstData1, dstData2, count1, count2, de1, de2, blockingFlag, commHandle, rc)
!
! !ARGUMENTS:
    type(ESMF_newDELayout),        intent(in)            :: delayout
...
! !REQUIREMENTS:  SSSn.n, GGGn.n
  ...
  end subroutine ESMF_newDELayoutCopyCopyR4
!------------------------------------------------------------------------------
...
! !INTERFACE:
  ! Private name; call using ESMF_newDELayoutCopyCopy()
  subroutine ESMF_newDELayoutCopyCopyR8(delayout, srcData1, srcData2, &
    dstData1, dstData2, count1, count2, de1, de2, blockingFlag, commHandle, rc)
!
! !ARGUMENTS:
    type(ESMF_newDELayout),        intent(in)            :: delayout
...
! !REQUIREMENTS:  SSSn.n, GGGn.n
  ...
  end subroutine ESMF_newDELayoutCopyCopyR8
!------------------------------------------------------------------------------
...
! !INTERFACE:
  ! Private name; call using ESMF_newDELayoutAllGlobalReduce()
  subroutine ESMF_newDELayoutGlobReduceI4(delayout, srcData, &
    dstData, count, operation, blockingFlag, commHandle, rc)
!
! !ARGUMENTS:
    type(ESMF_newDELayout),        intent(in)            :: delayout
...
! !REQUIREMENTS:  SSSn.n, GGGn.n
  ...
  end subroutine ESMF_newDELayoutGlobReduceI4
!------------------------------------------------------------------------------
...
! !INTERFACE:
  ! Private name; call using ESMF_newDELayoutAllGlobalReduce()
  subroutine ESMF_newDELayoutGlobReduceR4(delayout, srcData, &
    dstData, count, operation, blockingFlag, commHandle, rc)
!
! !ARGUMENTS:
    type(ESMF_newDELayout),        intent(in)            :: delayout
...
! !REQUIREMENTS:  SSSn.n, GGGn.n
  ...
  end subroutine ESMF_newDELayoutGlobReduceR4
!------------------------------------------------------------------------------
...
! !INTERFACE:
  ! Private name; call using ESMF_newDELayoutAllGlobalReduce()
  subroutine ESMF_newDELayoutGlobReduceR8(delayout, srcData, &
    dstData, count, operation, blockingFlag, commHandle, rc)
!
! !ARGUMENTS:
    type(ESMF_newDELayout),        intent(in)            :: delayout
...
! !REQUIREMENTS:  SSSn.n, GGGn.n
  ...
  end subroutine ESMF_newDELayoutGlobReduceR8
!------------------------------------------------------------------------------
