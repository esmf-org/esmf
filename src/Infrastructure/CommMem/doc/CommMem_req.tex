% $Id: CommMem_req.tex,v 1.4 2002/07/18 03:38:32 cnh Exp $
...
\req{Built-in {\bf \shortname} reporting, managing and monitoring mechanisms are required.}
\begin{reqlist}
{\bf Priority:} Priority 1 \\
{\bf Source:}  MIT \\
{\bf Status:}  \\
...
%===============================================================================
%===============================================================================
\sreq{A pure pthreads or OpenMP threads binding must be available for all {\bf \shortname} primitives.}
%-------------------------------------------------------------------------------
\begin{reqlist}
{\bf Priority:} Priority 1 \\
{\bf Source:}  MIT \\
