! $Id: ESMF_FieldRegridEx.F90,v 1.43 2011/02/10 04:18:45 ESRL\ryan.okuinghttons Exp $
!
...
! Section~\ref{sec:ESMF_RegridWeightGen} for a description of the offline regridding application and the options it supports.
! 
