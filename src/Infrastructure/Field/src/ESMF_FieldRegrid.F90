! $Id: ESMF_FieldRegrid.F90,v 1.100 2012/03/19 20:54:11 feiliu Exp $
!
...
! \item\apiStatusModifiedSinceVersion{5.2.0r}
! \begin{description}
! \item[5.3.0] Added arguments {\tt srcFracField} and {\tt dstFracField}.
! \end{description}
! \end{itemize}
!
! !DESCRIPTION:
...
!       It's important the Grid objects in the {\tt srcField} and {\tt dstField} donot match, i.e.
!       they are different in either tological or geometric characteristics.
!       \end{sloppypar}
!       
