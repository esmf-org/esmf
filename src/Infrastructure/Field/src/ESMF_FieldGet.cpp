! $Id: ESMF_FieldGet.cpp,v 1.14 2007/03/02 22:58:21 theurich Exp $
!
...
TypeKindRankInterfaceMacro(FieldGetDataPointer)
...
TypeKindRankDeclarationMacro(FieldGetDataPointer)
