...
// ESMC Distributed Array method implementation (body) file
...
// in the companion file ESMC_DistArray.h.  
//
// The {\tt ESMF\_Array} object allows C++ to emulate the richer
// Fortran language Array operations.  It does grid type operations
// on regular gridded array data.
//
//-----------------------------------------------------------------------------
//
...
//-----------------------------------------------------------------------------
 ...
 static const char *const version = 
            "$Id: ESMC_DistArray.C,v 1.1 2003/07/10 14:55:58 nscollins Exp $";
//-----------------------------------------------------------------------------
...
//-----------------------------------------------------------------------------
//
// This section includes all the distributed Array routines
//
//
//-----------------------------------------------------------------------------
//BOP
