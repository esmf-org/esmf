% $Id: Field_obj.tex,v 1.5 2007/02/16 05:27:43 rosalind Exp $
...
Data TypeKind may either be part of the Type or may be 
...
%\begin{figure}
%\caption[Bundle hierarchy]{The object hierarchy for objects closely related to Bundles.}
