...
! The following line turns the CVS identifier string into a printable variable.
    ...
    rc = ESMF_SUCCESS
    ! do test
    call test_regridPredefinedDstMaskR8R8R8(rc)
    ...
    rc = ESMF_SUCCESS
    ! do test
    call test_regridPredefinedDstMaskR8R8R8V(rc)
    ...
    rc = ESMF_SUCCESS
    ! do test
    call test_regridPredefinedDstMaskR4R8R4(rc)
    ...
    rc = ESMF_SUCCESS
    ! do test
    call test_regridPredefinedDstMaskR4R8R4V(rc)
    ...
    rc = ESMF_SUCCESS
    ! do test
    call test_regridPredefinedDstMaskR4R8R4_ungridded(rc)
    ...
    rc = ESMF_SUCCESS
    ! do test
    call test_regridPredefinedDstMaskR4R8R4V_ungridded(rc)
...
#define ESMF_METHOD "ESMF_TESTS"
    ...
    subroutine test_regridPredefinedDstMaskR8R8R8(rc)
       ...
       integer :: undef_count_before, undef_count_after, global_count(1)
       integer :: clbnd(2),cubnd(2)
       real(ESMF_KIND_R8) :: undef_value, def_value, zero_value
       ...
       call ESMF_FieldRegridStore(srcField, dstField, regridMethod=ESMF_REGRIDMETHOD_BILINEAR, &
            linetype=ESMF_LINETYPE_GREAT_CIRCLE, srcTermProcessing=srcTermProcessing, routeHandle=rh, &
       ...
       do lde = 0,localDECount-1
          ...
          do i1=clbnd(1),cubnd(1)
             do i2=clbnd(2),cubnd(2)
                if (i1 .lt. dst_nx/2 .and. i2 .lt. dst_ny/2) then
                   dstPtr(i1,i2)= undef_value
                   undef_count_before = undef_count_before + 1
                end if
             enddo
          enddo
       enddo
        call ESMF_FieldRegrid(srcField, dstField, routeHandle=rh, dynamicMask=dyn_mask, zeroregion=ESMF_REGION_EMPTY, rc=localrc)
       _VERIFY(localrc) 
       call ESMF_VMAllReduce(vm, [undef_count_before], global_count, 1, ESMF_REDUCE_SUM, rc=localrc)
       _VERIFY(localrc)

       undef_count_after = count_value_in_field_r8_2d(dstField, undef_value, 0.0001d0, rc=localrc)
       _VERIFY(localrc)
    ...
    end subroutine test_regridPredefinedDstMaskR8R8R8

    subroutine test_regridPredefinedDstMaskR8R8R8V(rc)
       integer, intent(out) :: rc
    ...
    end subroutine test_regridPredefinedDstMaskR8R8R8V

    subroutine test_regridPredefinedDstMaskR4R8R4(rc)
       integer, intent(out) :: rc
       ...
       undef_count_after = count_value_in_field_r4_2d(dstField, undef_value, 0.001, rc=localrc)
       _VERIFY(localrc)
    ...
    end subroutine test_regridPredefinedDstMaskR4R8R4

    subroutine test_regridPredefinedDstMaskR4R8R4V(rc)
       integer, intent(out) :: rc
       ...
       undef_count_after = count_value_in_field_r4_3d(dstField, undef_value, 0.001, rc=localrc)
       _VERIFY(localrc)
    ...
    end subroutine test_regridPredefinedDstMaskR4R8R4V

    subroutine test_regridPredefinedDstMaskR4R8R4_ungridded(rc)
       integer, intent(out) :: rc
    ...
    end subroutine test_regridPredefinedDstMaskR4R8R4_ungridded

    subroutine test_regridPredefinedDstMaskR4R8R4V_ungridded(rc)
       integer, intent(out) :: rc
    ...
    end subroutine test_regridPredefinedDstMaskR4R8R4V_ungridded
