...
! The following line turns the CVS identifier string into a printable variable.
    ...
    rc = ESMF_SUCCESS
    ! do test
    call test_regridPredefinedSrcMaskR8R8R8V(rc)
    ...
    rc = ESMF_SUCCESS
    ! do test
    call test_regridPredefinedSrcMaskR4R8R4(rc)
    ...
    rc = ESMF_SUCCESS
    ! do test
    call test_regridPredefinedSrcMaskR4R8R4V(rc)
...
#define ESMF_METHOD "ESMF_TESTS"
    ...
    subroutine test_regridPredefinedSrcMaskR8R8R8V(rc)
       ...
       _VERIFY(localrc)
       undef_count = count_value_in_field_r8_2d(dstField, undef_value, 0.0001d0, rc=localrc)
       _VERIFY(localrc)
       def_count = count_value_in_field_r8_2d(dstField, def_value, 0.0001d0, rc=localrc)
       _VERIFY(localrc)
    ...
    end subroutine test_regridPredefinedSrcMaskR8R8R8V
    ...
    subroutine test_regridPredefinedSrcMaskR4R8R4(rc)
       integer, intent(out) :: rc
       ...
       call ESMF_GridGet(dstGrid, localDECount=localDECount, rc=localrc)
       _VERIFY(localrc)
       undef_count = count_value_in_field_r4_2d(dstField, undef_value, 0.001, rc=localrc)
       _VERIFY(localrc)
       def_count = count_value_in_field_r4_2d(dstField, def_value, 0.001, rc=localrc)
       _VERIFY(localrc)
    ...
    end subroutine test_regridPredefinedSrcMaskR4R8R4

    subroutine test_regridPredefinedSrcMaskR4R8R4V(rc)
       integer, intent(out) :: rc
