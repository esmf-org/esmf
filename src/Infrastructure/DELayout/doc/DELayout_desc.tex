% $Id: DELayout_desc.tex,v 1.9 2005/11/30 23:30:17 theurich Exp $
...
importantly though, because it is unknown until the DELayout has been created, is the {\it PET-local} information that is provided by the DELayout Get methods.
