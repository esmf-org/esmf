! $Id: ESMF_ArrayFromF90Array1DePerPetEx.F90,v 1.1 2006/05/03 04:47:31 theurich Exp $
!
...
!EOE
!BOC
program ESMF_ArrayFromF90Array1DePerPetEx
...
!EOC
  ...
  if (finalrc==ESMF_SUCCESS) then
    print *, "PASS: ESMF_ArrayFromF90Array1DePerPetEx.F90"
  else
    print *, "FAIL: ESMF_ArrayFromF90Array1DePerPetEx.F90"
  endif
