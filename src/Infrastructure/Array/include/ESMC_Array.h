// $Id: ESMC_Array.h,v 1.12 2003/07/31 19:08:57 atrayanov Exp $
//
...
class ESMC_Array : public ESMC_LocalArray {  // inherits from LocalArray class
   ...
   private:
    //struct ESMC_DELayout delayout;   // nsc - would this help us?
...
//  other than deleting the memory for the object/derived type itself.
 ...
 // optional index values for subsetting and handling arrays standalone
    ...
    int ESMC_ArrayGetAllAxisIndices(struct ESMC_AxisIndex *global, int nDEs,
                 struct ESMC_AxisIndex *total, struct ESMC_AxisIndex *comp,
                 struct ESMC_AxisIndex *excl) const; 
 ...
 // get/set methods for internal data
    ...
    int ESMC_ArrayHalo(ESMC_DELayout *layout,
                       ...
                       int decompids[], int size_decomp, int periodic[]);
