!  $Id: ESMF_Array_C.F90,v 1.3.2.1 2012/01/06 20:42:09 svasquez Exp $
!
...
!
!==============================================================================
#define ESMF_FILENAME "ESMF_Array_C.F90"
!
!------------------------------------------------------------------------------
! INCLUDES
#include "ESMF.h"
...
#undef  ESMF_METHOD
#define ESMF_METHOD "f_esmf_arrayread"
  subroutine f_esmf_arrayread(array, file, variableName, &
    timeslice, iofmt, rc)
...
!
  ...
  end subroutine f_esmf_arrayread
!------------------------------------------------------------------------------

#undef  ESMF_METHOD
#define ESMF_METHOD "f_esmf_arraywrite"
  subroutine f_esmf_arraywrite(array, file,  &
...
!------------------------------------------------------------------------------
  ...
  end subroutine f_esmf_arraywrite
