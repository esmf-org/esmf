...
#define MEMLOG_off
  ...
  try {
    ...
    ESMCI_REGRID_TRACE_ENTER("NVMesh Weight Generation");
    ...
    ESMCI_REGRID_TRACE_EXIT("NVMesh Weight Generation");
...
#define ESMF_REGRID_DEBUG_OUTPUT_WTS_ALL_off
    ...
    ESMCI_REGRID_TRACE_ENTER("NVMesh ArraySMMStore");
    ...
    ESMCI_REGRID_TRACE_EXIT("NVMesh ArraySMMStore");
