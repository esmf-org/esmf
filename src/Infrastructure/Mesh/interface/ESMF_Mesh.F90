...
!   \item[fileformat]
!         The file format. The valid options are {\tt ESMF\_FILEFORMAT\_SCRIP}, {\tt ESMF\_FILEFORMAT\_ESMFMESH}, 
!         {\tt ESMF\_FILEFORMAT\_UGRID}, and {\tt ESMF\_FILEFORMAT\_SHAPEFILE}.
