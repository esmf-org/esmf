...
#define ESMC_METHOD "MBMeshRegidUTest::main()"
  ...
  ESMC_TestStart("ESMCI_MeshCapRegridGenUTest.C", __LINE__, 0);
  ...
  tagfile.open("ESMCI_MeshCapRegridGenUTest.C", std::ios_base::app);
  ...
  //----------------------------------------------------------------------------
  ESMC_TestEnd("ESMCI_MeshCapRegridGenUTest.C", __LINE__, 0);
