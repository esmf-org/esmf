% $Id: Mesh_desc.tex,v 1.2 2009/09/23 23:13:01 oehmke Exp $
...
ESMF currently supports two types of element for each Mesh parametric dimension. For a parametric dimension of 2 the 
