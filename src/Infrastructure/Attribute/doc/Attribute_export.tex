% $Id: Attribute_export.tex,v 1.13 2012/11/20 17:32:43 rokuingh Exp $
%
...
purpose="GridSpec", and {\tt ESMF\_AttWriteFlag} is set to {\tt ESMF\_ATTWRITE\_XML}, an XML file conforming to the developing CF 1.6 GridSpec standard will be written.  The file will be named for the name of the ESMF Component object from which {\tt ESMF\_AttributeWrite()} is called, and the suffix will be .xml.  This file is written by pulling internal information out of the Grid object.  It is 
