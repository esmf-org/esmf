% $Id: Attribute_export.tex,v 1.11 2012/11/09 05:33:07 ksaint Exp $
%
...
it contains a Grid), and the Attribute package convention="CIM 1.5", and the 
purpose="GridSpec", and {\tt ESMF\_AttWriteFlag} is set to {\tt ESMF\_ATTWRITE\_XML}, an XML file conforming to the CIM 1.5 GridSpec standard will be written.  The file will be named for the name of the ESMF Component object from which {\tt ESMF\_AttributeWrite()} is called, and the suffix will be .xml.
