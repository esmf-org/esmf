% $Id: Attribute_desc.tex,v 1.54.4.2 2012/10/30 20:33:04 ksaint Exp $
%
...
ESMF is currently implementing only a subset of the CIM, though this representation is expected to grow. 
...
SoftwareComponent entity (see Figure \ref{fig:SoftwareComponentUML} ).
		
\begin{figure}[h]
\centering
\includegraphics{SoftwareComponentUML}
\caption{The SoftwareComponent Entity in the CIM UML Diagram}
\label{fig:SoftwareComponentUML}
\end{figure}
\clearpage
