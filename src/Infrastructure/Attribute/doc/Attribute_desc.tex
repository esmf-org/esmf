% $Id: Attribute_desc.tex,v 1.49 2011/05/25 20:04:21 rokuingh Exp $
%
...
automatically for the most part, with the exception of links between a 
Component and a State.  Attribute hierarchies can also be unlinked, copied, 
...
processors and updated at runtime, and expanded to suite specific needs.  The
ESMF-supplied  
