% $Id: Attribute_pack.tex,v 1.38 2011/06/09 05:58:47 eschwab Exp $
%
...
** If SpatialRegriddingMethod is set, SpatialRegriddingDimension must also be set, to produce valid CIM XML output. \\
...
\begin{longtable}{|p{7cm}|p{5cm}|p{2cm}}
     ...
     {\tt LongName} & The name of an object with all acronyms spelled out. For fields, it is an ad-hoc long descriptive name which may, for example, be used for labeling plots. & CF General\\
     ...
     {\tt URL} & URL of the object being described. Exists in multple packages. & ISO Responsible Party, CIM Main, ISO Citation\\
