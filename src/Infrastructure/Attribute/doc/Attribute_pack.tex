% $Id: Attribute_pack.tex,v 1.40 2011/06/23 21:33:18 svasquez Exp $
%
...
\begin{tabular}{|p{7cm}|p{5cm}|p{2cm}}
     ...
     {\tt SimulationMetadataVersion***} & The version number of the simulation metadata. & N/A \\ 
...
\end{tabular}
\begin{description}
 \item[*] Attribute required to be set to produce valid CIM XML output. \\
 \item[**] If PreviousVersionDescription is set, PreviousVersion must also be set, to produce valid CIM XML output. \\
 \item[***] If not set, defaults to 1.0
\end{description}
...
\begin{description}
  \item[*] Attribute required to be set to produce valid CIM XML output. \\
  \item[**] Both CompilerName and CompilerVersion are required to be set, or else neither one, to produce valid CIM XML output; setting one without the other will produce invalid CIM XML output. \\
\end{description}
...
\end{tabular}
\begin{description}
  \item[*] Attribute required to be set, when any other attributes in this package are set, to produce valid CIM XML output. It is valid to set none of the attributes in this package. In that case, no corresponding CIM XML output will appear for that Responsible Party package instance, although there may be other populated instances, which, because they have attributes set, will appear in the output. \\
\end{description}
...
\begin{itemize}
    ...
    \begin{itemize}
        \item CIM XML
    \end{itemize}  
    \item Description: This package is used to specify any user-defined attributes of a component and have them output in valid CIM XML format.
\end{itemize}
...
\begin{tabular}{|p{7cm}|p{5cm}|p{2cm}}
     ...
     {\bf Name} & {\bf Definition} & {\bf Controlled Vocabulary}\\
     \hline\hline
     {\tt <User-defined name 1>} & <User-defined definition 1>. & N/A \\
     {\tt <User-defined name 2>} & <User-defined definition 2>. & N/A \\
     {\tt <...>} & <...> & N/A \\
     {\tt <User-defined name n>} & <User-defined definition n>. & N/A \\
     \hline\hline
\end{tabular}
...
\end{tabular}
\begin{description}
 \item[*] Attribute required to be set, when any other attributes in this package are set, to produce valid CIM XML output. It is valid to set none of the attributes in this package. In that case, no corresponding CIM XML output will appear for that Inputs package. \\
 \item[**] If SpatialRegriddingMethod is set, SpatialRegriddingDimension must also be set, to produce valid CIM XML output. \\
\end{description}
...
\end{tabular}
\begin{description}
 \item[*] Attribute required to be set, if any attributes are set within this package, the CF/Extended, or ESMF/General package, to produce valid CIM XML output. It is valid to set none of the attributes in this package, the CF/Extended, or ESMF/General package, in which case no field CIM output will be produced. \\
\end{description}
...
\begin{longtable}{|p{7cm}|p{5cm}|p{2cm}}
     ...
     {\tt ShortName}  & For component: a version of the component name that contains acronyms.  For field:  The short\_name is technically not part of the CF stanard but is commonly the name of the variable on the output file and so is distinct from the long\_name. & CIM Main, CF General\\
     ...
     {\tt SimulationMetadataVersion} & The version number of the simulation metadata. & CIM Main\\ 
