% $Id: Attribute_pack.tex,v 1.53.4.4 2012/10/30 20:33:04 ksaint Exp $
%
...
\begin{itemize}
    \item Specify with: 
    \begin{itemize}
        \item {\bf convention} = "ESG" or "ESMF"
        \item {\bf purpose} = "General"
    \end{itemize} 
    \item Output Options:
    \begin{itemize}
        \item Simple XML
...
\begin{itemize}
    \item Specify with: 
    \begin{itemize}
        \item {\bf convention} = "CIM"
        \item {\bf purpose} = "Model Component Simulation Description"
    \end{itemize} 
...
\begin{itemize}
    ...
    \begin{itemize}
        \item {\bf convention} = "CIM"
        \item {\bf purpose} = "Platform Description"
    \end{itemize} 
    \item CIM Version: CIM 1.5 
    \item CIM URL: \htmladdnormallink{http://metaforclimate.eu/trac/browser/CIM/tags/version-1.5/}{http://metaforclimate.eu/trac/browser/CIM/tags/version-1.5/}
    \item Output Options:
...
\begin{tabular}{|p{5cm}|p{5cm}|p{35mm}|p{15mm}|}
     ...
     {\tt MachineVendor} & The brand name of a computer system. & ACS, Action, Appro International, Bull SA, Cray Inc, Dalco AG Switzerland, Dawning, Dell, Fujitsu, Hitachi, HP, IBM, Intel, Koi Computers, Lenovo, Mac, NEC, NEC SUN, NUDT, PC, Pyramid Computer, Raytheon-Aspen Systems, Self Made, SGI, Sun Microsystems, T-platorms & shared:Machine:machineVendor \\
     \hline\hline
\end{tabular}
\linebreak
* Attribute required to be set to produce valid CIM XML output. \\
...
\begin{itemize}
    \item Specify with: 
    \begin{itemize}
        \item {\bf convention} = "ISO 19115"
        \item {\bf purpose} = "Responsible Party Description"
    \end{itemize} 
    \item Output Options: 
    \begin{itemize}
        \item CIM XML 
...
\begin{itemize}
    ...
    \begin{itemize}
        \item {\bf convention} = "ISO 19115"
        \item {\bf purpose} = "Citation Description"
    \end{itemize} 
    \item Output Options: 
    \begin{itemize}
        \item CIM XML 
...
\begin{itemize}
    ...
    \begin{itemize}
        \item {\bf convention} = "CIM"
        \item {\bf purpose} = "Scientific Properties Description"
    \end{itemize} 
    \item CIM Version: CIM 1.5 
    \item CIM URL: \htmladdnormallink{http://metaforclimate.eu/trac/browser/CIM/tags/version-1.5/}{http://metaforclimate.eu/trac/browser/CIM/tags/version-1.5/}
    \item CV Version: 1.3 
...
\begin{itemize}
    ...
    \begin{itemize}
        \item {\bf convention} = "CIM"
        \item {\bf purpose} = "General Component Properties Description"
    \end{itemize} 
    \item CIM Version: CIM 1.5 
    \item CIM URL: \htmladdnormallink{http://metaforclimate.eu/trac/browser/CIM/tags/version-1.5/}{http://metaforclimate.eu/trac/browser/CIM/tags/version-1.5/}
    \item Output Options: 
...
\begin{itemize}
    ...
    \begin{itemize}
        \item {\bf convention} = "CIM"
        \item {\bf purpose} = "Inputs Description"
    \end{itemize} 
    \item CIM Version: CIM 1.5 
    \item CIM URL: \htmladdnormallink{http://metaforclimate.eu/trac/browser/CIM/tags/version-1.5/}{http://metaforclimate.eu/trac/browser/CIM/tags/version-1.5/}
    \item Includes: 
...
\begin{itemize}
    \item Specify with: 
    \begin{itemize}
        \item {\bf convention} = "CF"
        \item {\bf purpose} = "Extended"
    \end{itemize} 
    \item Includes: 
    \begin{itemize}
        \item CF General
