% $Id: Attribute_pack.tex,v 1.15 2010/10/05 19:38:06 murphysj Exp $
%
...
\begin{tabular}{|p{8cm}|p{20cm}|p{10cm}|}
     {\bf Name } & {\bf Definition} & {\bf Controlled Vocabulary} \\
     \hline\hline
     {\tt CitationDate} & The date of the citation. & N/A\\
     {\tt CitationDOI} & The assigned Digital Object Identifier (DOI) of the citation & N/A\\
     {\tt CitationLongTitle} & The text of the citation or pointer (e.g. URL) that further describes a model component or simulation. & N/A\\
     {\tt CitationPresentationForm} & A description of the type of citation & documentDigital, documentHardcopy, imageDigital, imageHardcopy, mapDigital, mapHardcopy, modelDigital, modelHardcopy, profileDigital, profileHardcopy, tableDigital, tableHardcopy, videoDigital, videoHardcopy\\
     {\tt CitationShortTitle} & An abbreviation for the citation.  This could be the short scientific citation (e.g. Murphy, 2009) or the title of a web page. & N/A \\     {\tt URL} & Website associated with the citation. & N/A\\
\end{tabular}
...
\begin{tabular}{|p{8cm}|p{20cm}|p{10cm}|}
    {\bf Name} & {\bf Definition} & {\bf Controlled Vocabulary} \\
    \hline\hline
    {\tt InputFrequency} & The frequency (e.g. months, days) that a field from one component is input to another. & N/A\\ 
...
\begin{tabular}{|p{8cm}|p{20cm}|p{10cm}}
     ...
     {\tt CitationLongTitle} & The text of the citation or pointer (e.g. URL) that further describes a model component or simulation. & N/A\\
     {\tt CitationPresentationForm} & A description of the type of citation & documentDigital, documentHardcopy, imageDigital, imageHardcopy, mapDigital, mapHardcopy, modelDigital, modelHardcopy, profileDigital, profileHardcopy, tableDigital, tableHardcopy, videoDigital, videoHardcopy\\
     {\tt CitationShortTitle} & An abbreviation for the citation.  This could be the short scientific citation (e.g. Murphy, 2009) or the title of a web page. & N/A \\     
