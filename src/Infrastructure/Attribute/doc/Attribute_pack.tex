% $Id: Attribute_pack.tex,v 1.17 2010/10/07 19:39:51 murphysj Exp $
%
...
\begin{tabular}{|p{8cm}|p{20cm}|p{10cm}}
     ...
     {\tt ShortName} & A version of the component name that contains acronyms. & CIM Main\\
     {\tt LongName} & A version of the component name with all acronyms spelled out. & CIM Main\\
     ...
     {\tt ResponsiblePartyName} & The person designated to provide information about a model component. & CIM Responsible Party\\
     ...
     {\tt Intent} & An indication of whether a field or state is imported into or exported from a particular model component. This refers to coupling, and not history outout. & ESMF State, ESMF Field\\
