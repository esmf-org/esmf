% $Id: Attribute_pack.tex,v 1.30 2011/02/25 07:01:02 eschwab Exp $
%
...
There are many attributes that are used to describe components. There are currently 2 predefined component-level Attribute packages, with sub-packages defined for the 2nd:
...
{\bf 2a. CIM Platform Attribute Package}
...
\vspace{.20in}
{\bf 2b. ISO Responsible Party Attribute Package}
...
\vspace{.20in}
{\bf 2c. ISO Citation Attribute Package}
