% $Id: Attribute_pack.tex,v 1.10 2010/09/14 18:30:08 murphysj Exp $
%
...
\begin{tabular}{|p{8cm}|p{20cm}|p{10cm}|}
     ...
     {\tt InstitutionName} & An organization associated with a model component or simulation. & N/A \\
     {\tt InstitutionPhysicalAddress} & The address of an organization associated with a model component or simulation. & N/A \\
     {\tt InstitutionURL} & A website of an organization associated with a model component or simulation. & N/A \\
     {\tt InstitutionAbbreviation} & The abbreviation of an organization associated with a model component or simulation. & N/A \\
     {\tt PrincipalInvestigator} & The scientist in charge of an experiment or research project. & \\
...
\begin{itemize}
    ...
    \begin{itemize}
        \item CIM XML 
    \end{itemize} 
    \item Descriptipn: This package is used to describe references. Examples include a URL or a scientific reference. 
\end{itemize}
