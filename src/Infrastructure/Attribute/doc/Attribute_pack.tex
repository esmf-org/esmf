% $Id: Attribute_pack.tex,v 1.55 2012/11/20 17:32:43 rokuingh Exp $
%
...
\begin{itemize}
    ...
    \item CF URL: \htmladdnormallink{http://cf-pcmdi.llnl.gov/documents/cf-conventions/1.6/cf-conventions.pdf}{http://cf-pcmdi.llnl.gov/documents/cf-conventions/1.6/cf-conventions.pdf}
    \item CIM Version: CIM 1.5.1
    \item CIM Schema URL: \htmladdnormallink{http://www.purl.org/org/esmetadata/cim/1.5/schemas}{http://www.purl.org/org/esmetadata/cim/1.5/schemas}
    \item Output Options:
    \begin{itemize}
        \item Simple XML
