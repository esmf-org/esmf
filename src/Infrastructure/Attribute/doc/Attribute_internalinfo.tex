% $Id: Attribute_internalinfo.tex,v 1.6 2012/04/27 05:43:26 rokuingh Exp $
...
%%%
    ...
    %arbIndexList & {\tt integer(:,:)} & localDe & \hyperref[API:GridGetPLocalDe]{\tt ESMF\_GridGet()}\\
    ...
    % coordDimMap & {\tt integer(:,:)} & & \hyperref[API:GridGet]{\tt ESMF\_GridGet()}\\
    ...
    % distgrid & {\tt ESMF\_DistGrid} & & \hyperref[API:GridGet]{\tt ESMF\_GridGet()}\\
    % distgrid & {\tt ESMF\_DistGrid} & staggerloc,localDe & \hyperref[API:GridGetPSloc]{\tt ESMF\_GridGet()}\\
...
\begin{table}[h!p!b!]
  ...
  \begin{tabular}{|l|l|l|l|}
    ...
    \hline
%%%
    % array & {\tt ESMF\_Array} & coordDim, (optional) staggerloc & \hyperref[API:GridGetCoordIntoArray]{\tt ESMF\_GridGetCoord()}\\
    ...
    % coord & {\tt ESMF\_KIND\_R[4/8](:)} & index(:), (optional) staggerloc, (optional) localDe & \hyperref[API:GridGetCoordR8]{\tt ESMF\_GridGetCoord()}\\
...
\begin{table}[h!p!b!]
  ...
  \begin{tabular}{|l|l|l|l|}
    ...
    \hline
%%%
    % array & {\tt ESMF\_Array} & itemflag, (optional) staggerloc & \hyperref[API:GridGetItemIntoArray]{\tt ESMF\_GridGetItem()}\\
