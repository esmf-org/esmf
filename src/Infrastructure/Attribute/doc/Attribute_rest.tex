% $Id: Attribute_rest.tex,v 1.26 2012/11/09 05:33:07 ksaint Exp $
%
...
\item The implemention of Grids is still in flux within the CIM.  This will affect the final appearance of the Gridspec package in ESMF. It is anticipated that an additional CIM Grid Attribute Package will be created.
