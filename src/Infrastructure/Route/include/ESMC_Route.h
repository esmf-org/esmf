// $Id: ESMC_Route.h,v 1.1 2003/03/05 17:04:53 nscollins Exp $
//
...
//  other than deleting the memory for the object/derived type itself.
 ...
 // accessor methods for class members
    int ESMC_RouteGet<Value>(<value type> *value) const;
    int ESMC_RouteSet<Value>(<value type>  value);
...
// an ESMC_Route object.
 ...
 ESMC_Route *ESMC_RouteCreate(args, int *rc);// interface only, deep class
