// $Id: ESMC_VMKernel.C,v 1.33 2005/03/08 04:33:13 theurich Exp $
//
...
void ESMC_VMK::vmk_allreduce(void *in, void *out, int len, vmType type,
  ...
  if (mpionly){
    ...
    case vmSUM:
      ...
      break;
    case vmMIN:
      printf("ESMC_VMK: Reduce operation vmMIN is not yet implemented\n");
      break;
    case vmMAX:
      printf("ESMC_VMK: Reduce operation vmMAX is not yet implemented\n");
      break;
    }
    delete [] temparray;
  }  
...
void ESMC_VMK::vmk_allglobalreduce(void *in, void *out, int len, 
  vmType type, vmOp op){
