% $Id: PhysGrid_req.tex,v 1.6 2002/04/23 13:38:30 cnh Exp $
%===============================================================================
...
a valid (i.e. non-fault generating) physical grid operations on data which 
does not have a realizable physical grid, for example linear algebra space data values.
\end{reqlist}
\sreq{Initialization by Numerical Values}
In summary numerical initialization of a Physical grid is specified through a combination
...
using pre-calculated numerical values. The values required will be dependent on 
both the component application and on the Regridding requirements associted with the component. 
\ssreq{Initialization of grid cell locations}
