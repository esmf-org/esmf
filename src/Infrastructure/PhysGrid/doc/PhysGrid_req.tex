$Id: PhysGrid_req.tex,v 1.13 2002/05/13 19:50:39 pwjones Exp $
%cnh m%titude
%cnh ===============================================================================
...
\begin{reqlist}
{\bf Priority:} 1 \\
{\bf Source:} General Req. 8.0.2, CAM-EUL, POP \\
{\bf Status:} Proposed \\
{\bf Verification:} Code Inspection\\
{\bf Notes:} 
\end{reqlist}
...
\begin{reqlist}
{\bf Priority:}  \\
{\bf Source:} General Req. 1.5.2, CAM-EUL, CLM, CCSM-CPL, POP, CICE \\
{\bf Status:} Proposed \\
{\bf Verification:} Unit test\\
{\bf Notes:} If supported, this facility would dramatically complicate implementation,
without adding much functionality.
...
AM-EUL (XYZ, XZY, ZXY), POP(XYZ), CICE(XY) \\
{\bf Status:} Proposed \\
{\bf Verification:} Unit test\\
