! $Id: ESMF_TypeKindGetUTest.F90,v 1.1 2007/02/27 20:50:47 rosalind Exp $
!
...
! !USES:
      ...
      use ESMF_TypeKindGetMod     !  the ESMF_TypeKindGet function.
...
!=================================
    ...
    print *, "The typekind of ESMF_KIND_I1 integer is", typekind

    if(typekind%dkind /= ESMF_TYPEKIND_I1%dkind) then
       print*,'ERROR: typekind (=',typekind, &
              ') should equal ESMF_TYPEKIND_I1 (=', &
                 ESMF_TYPEKIND_I1,')'
     end if
    ...
    print *, "The typekind of ESMF_KIND_I2 integer is", typekind

    if(typekind%dkind /= ESMF_TYPEKIND_I2%dkind) then
       print*,'ERROR: typekind (=',typekind, &
              ') should equal ESMF_TYPEKIND_I2 (=', &
                 ESMF_TYPEKIND_I2,')'
     end if
    ...
    print *, "The typekind of ESMF_KIND_I4 integer is", typekind

    if(typekind%dkind /= ESMF_TYPEKIND_I4%dkind) then
       print*,'ERROR: typekind (=',typekind, &
              ') should equal ESMF_TYPEKIND_I4 (=', &
                 ESMF_TYPEKIND_I4,')'
     end if
    ...
    print *, "The typekind of ESMF_KIND_I8 integer is", typekind

    if(typekind%dkind /= ESMF_TYPEKIND_I8%dkind) then
       print*,'ERROR: typekind (=',typekind, &
              ') should equal ESMF_TYPEKIND_I8 (=', &
                 ESMF_TYPEKIND_I8,')'
     end if
...
!=================================
    ...
    print *, "The typekind of ESMF_KIND_R4 real is", typekind

    if(typekind%dkind /= ESMF_TYPEKIND_R4%dkind) then
       print*,'ERROR: typekind (=',typekind, &
              ') should equal ESMF_TYPEKIND_R4 (=', &
                 ESMF_TYPEKIND_R4,')'
     end if
    ...
    print *, "The typekind of ESMF_KIND_R8 real is", typekind

    if(typekind%dkind /= ESMF_TYPEKIND_R8%dkind) then
       print*,'ERROR: typekind (=',typekind, &
              ') should equal ESMF_TYPEKIND_R8 (=', &
                 ESMF_TYPEKIND_R8,')'
     end if
