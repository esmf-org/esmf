! $Id: ESMF_UtilTypes.F90,v 1.56.2.20 2010/04/03 04:31:40 theurich Exp $
!
...
!EOPI
      ...
      integer, parameter :: ESMF_PATCHLEVEL    = 4
      character(80), parameter :: ESMF_VERSION_STRING = "3.1.0rp4 beta snapshot"
