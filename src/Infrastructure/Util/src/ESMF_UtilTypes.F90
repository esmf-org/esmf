! $Id: ESMF_UtilTypes.F90,v 1.56.2.23 2011/08/16 17:48:34 theurich Exp $
!
...
!EOPI
      ...
      integer, parameter :: ESMF_PATCHLEVEL    = 6
      character(80), parameter :: ESMF_VERSION_STRING = "3.1.0rp6 beta snapshot"
