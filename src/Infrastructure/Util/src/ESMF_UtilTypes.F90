! $Id: ESMF_UtilTypes.F90,v 1.56.2.18 2010/02/01 20:52:30 svasquez Exp $
!
...
!EOPI
      ...
      integer, parameter :: ESMF_PATCHLEVEL    = 3
      character(80), parameter :: ESMF_VERSION_STRING = "3.1.0rp3 beta snapshot"
