! $Id: ESMF_UtilTypes.F90,v 1.56.2.22 2011/08/11 19:16:21 theurich Exp $
!
...
!EOPI
      ...
      integer, parameter :: ESMF_PATCHLEVEL    = 5
      character(80), parameter :: ESMF_VERSION_STRING = "3.1.0rp5 beta snapshot"
