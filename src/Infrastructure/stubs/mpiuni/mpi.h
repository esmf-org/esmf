/* $Id: mpi.h,v 1.5 2007/02/16 05:27:49 rosalind Exp $ */
...
#define MPIU_PETSCLOGDOUBLE sizeof(PetscLog Double)
...
#define MPI_Init(argc,argv) \
     (MPIUNI_TMP = (void*)( (ESMC_I8)) (argc),\
      MPIUNI_TMP = (void*)( (ESMC_I8)) (argv),\
      MPI_SUCCESS)
#define MPI_Init_thread(argc,argv,required,provided) \
     (MPIUNI_TMP = (void*)( (ESMC_I8)) (argc),\
      MPIUNI_TMP = (void*)( (ESMC_I8)) (argv),\
      MPIUNI_TMP = (void*)( (ESMC_I8)) (required),\
      MPIUNI_TMP = (void*)( (ESMC_I8)) (provided),\
      MPI_SUCCESS)
#define MPI_Send(buf,count,datatype,dest,tag,comm)  \
     (MPIUNI_TMP = (void*)( (ESMC_I8)) (buf),\
      MPIUNI_TMP = (void*)( (ESMC_I8)) (count),\
      MPIUNI_TMP = (void*)( (ESMC_I8)) (datatype),\
      MPIUNI_TMP = (void*)( (ESMC_I8)) (dest),\
      MPIUNI_TMP = (void*)( (ESMC_I8)) (tag),\
      MPIUNI_TMP = (void*)( (ESMC_I8)) (comm),\
      MPI_SUCCESS)
#define MPI_Recv(buf,count,datatype,source,tag,comm,status) \
     (MPIUNI_TMP = (void*)( (ESMC_I8)) (buf),\
      MPIUNI_TMP = (void*)( (ESMC_I8)) (count),\
      MPIUNI_TMP = (void*)( (ESMC_I8)) (datatype),\
      MPIUNI_TMP = (void*)( (ESMC_I8)) (source),\
      MPIUNI_TMP = (void*)( (ESMC_I8)) (tag),\
      MPIUNI_TMP = (void*)( (ESMC_I8)) (comm),\
      MPIUNI_TMP = (void*)( (ESMC_I8)) (status),\
...
#define MPI_Buffer_attach(buffer,size) \
     (MPIUNI_TMP = (void*)( (ESMC_I8)) (buffer),\
      MPIUNI_TMP = (void*)( (ESMC_I8)) (size),\
      MPI_SUCCESS)
...
#define MPI_Ibsend(buf,count, datatype,dest,tag,comm,request) \
     (MPIUNI_TMP = (void*)( (ESMC_I8)) (buf),\
       ...
       MPIUNI_TMP = (void*)( (ESMC_I8)) (tag),\
       MPIUNI_TMP = (void*)( (ESMC_I8)) (comm),\
       MPIUNI_TMP = (void*)( (ESMC_I8)) (request),\
       MPI_SUCCESS)
...
#define MPI_Waitany(a,b,c,d) \
     (MPIUNI_TMP = (void*)( (ESMC_I8)) (a),\
      MPIUNI_TMP = (void*)( (ESMC_I8)) (b),\
      MPIUNI_TMP = (void*)( (ESMC_I8)) (c),\
      MPIUNI_TMP = (void*)( (ESMC_I8)) (d),\
      MPI_SUCCESS)
#define MPI_Testany(a,b,c,d,e) \
     (MPIUNI_TMP = (void*)( (ESMC_I8)) (a),\
      ...
      MPIUNI_TMP = (void*)( (ESMC_I8)) (c),\
      MPIUNI_TMP = (void*)( (ESMC_I8)) (d),\
      MPIUNI_TMP = (void*)( (ESMC_I8)) (e),\
      MPI_SUCCESS)
#define MPI_Waitall(count,array_of_requests,array_of_statuses) \
     (MPIUNI_TMP = (void*)( (ESMC_I8)) (count),\
      MPIUNI_TMP = (void*)( (ESMC_I8)) (array_of_requests),\
      MPIUNI_TMP = (void*)( (ESMC_I8)) (array_of_statuses),\
      MPI_SUCCESS)
#define MPI_Testall(count,array_of_requests,flag,array_of_statuses) \
     (MPIUNI_TMP = (void*)( (ESMC_I8)) (count),\
      MPIUNI_TMP = (void*)( (ESMC_I8)) (array_of_requests),\
      MPIUNI_TMP = (void*)( (ESMC_I8)) (flag),\
      MPIUNI_TMP = (void*)( (ESMC_I8)) (array_of_statuses),\
      MPI_SUCCESS)
#define MPI_Waitsome(incount,array_of_requests,outcount,\
                     array_of_indices,array_of_statuses) \
     (MPIUNI_TMP = (void*)( (ESMC_I8)) (incount),\
      MPIUNI_TMP = (void*)( (ESMC_I8)) (array_of_requests),\
      MPIUNI_TMP = (void*)( (ESMC_I8)) (outcount),\
      MPIUNI_TMP = (void*)( (ESMC_I8)) (array_of_indices),\
      MPIUNI_TMP = (void*)( (ESMC_I8)) (array_of_statuses),\
      MPI_SUCCESS)
#define MPI_Comm_group(comm,group) \
     (MPIUNI_TMP = (void*)( (ESMC_I8)) (comm),\
      MPIUNI_TMP = (void*)( (ESMC_I8)) (group),\
      MPI_SUCCESS)
#define MPI_Group_incl(group,n,ranks,newgroup) \
     (MPIUNI_TMP = (void*)( (ESMC_I8)) (group),\
      MPIUNI_TMP = (void*)( (ESMC_I8)) (n),\
      MPIUNI_TMP = (void*)( (ESMC_I8)) (ranks),\
      MPIUNI_TMP = (void*)( (ESMC_I8)) (newgroup),\
      MPI_SUCCESS)
...
#define MPI_Cancel(request) (MPIUNI_TMP = (void*)( (ESMC_I8)) (request),MPI_SUCCESS)
...
#define MPI_Recv_init(buf,count, datatype,source,tag,comm,request) \
     ...
     MPIUNI_TMP = (void*)( (ESMC_I8)) (request),\
     MPI_SUCCESS)
#define MPI_Start(request) (MPIUNI_TMP = (void*)( (ESMC_I8)) (request),MPI_SUCCESS)
#define MPI_Startall(count,array_of_requests) \
     (MPIUNI_TMP = (void*)( (ESMC_I8)) (count),\
     MPIUNI_TMP = (void*)( (ESMC_I8)) (array_of_requests),\
     MPI_SUCCESS)
#define MPI_Op_create(function,commute,op) \
     (MPIUNI_TMP = (void*)( (ESMC_I8)) (function),\
     MPIUNI_TMP = (void*)( (ESMC_I8)) (commute),\
     MPIUNI_TMP = (void*)( (ESMC_I8)) (op),\
     MPI_SUCCESS)
...
#define MPI_Address(location,address) \
     (*(address) = ( (ESMC_I8))(char *)(location),MPI_SUCCESS)
...
#define MPI_Type_ub(datatype,displacement) \
     MPI_Abort(MPI_COMM_WORLD,0)
#define MPI_Type_commit(datatype) (MPIUNI_TMP = (void*)( (ESMC_I8)) (datatype),\
     MPI_SUCCESS)
...
#define MPI_Gather(sendbuf,sendcount, sendtype,\
     ...
     root,comm) \
     (MPIUNI_TMP = (void*)( (ESMC_I8)) (recvcount),\
     MPIUNI_TMP = (void*)( (ESMC_I8)) (root),\
     MPIUNI_TMP = (void*)( (ESMC_I8)) (recvtype),\
     MPIUNI_TMP = (void*)( (ESMC_I8)) (comm),\
     MPIUNI_Memcpy(recvbuf,sendbuf,(sendcount)* (sendtype)),\
     MPI_SUCCESS)
#define MPI_Gatherv(sendbuf,sendcount, sendtype,\
     ...
     recvtype,root,comm) \
     (MPIUNI_TMP = (void*)( (ESMC_I8)) (recvcounts),\
     MPIUNI_TMP = (void*)( (ESMC_I8)) (displs),\
     MPIUNI_TMP = (void*)( (ESMC_I8)) (recvtype),\
     MPIUNI_TMP = (void*)( (ESMC_I8)) (root),\
     MPIUNI_TMP = (void*)( (ESMC_I8)) (comm),\
     MPIUNI_Memcpy(recvbuf,sendbuf,(sendcount)* (sendtype)),\
...
#define MPI_Scatter(sendbuf,sendcount, sendtype,\
     recvbuf,recvcount, recvtype,\
     root,comm) \
     (MPIUNI_TMP = (void*)( (ESMC_I8)) (sendbuf),\
     MPIUNI_TMP = (void*)( (ESMC_I8)) (sendcount),\
     MPIUNI_TMP = (void*)( (ESMC_I8)) (sendtype),\
     MPIUNI_TMP = (void*)( (ESMC_I8)) (recvbuf),\
     MPIUNI_TMP = (void*)( (ESMC_I8)) (recvcount),\
     MPIUNI_TMP = (void*)( (ESMC_I8)) (recvtype),\
     MPIUNI_TMP = (void*)( (ESMC_I8)) (root),\
     MPIUNI_TMP = (void*)( (ESMC_I8)) (comm),MPI_Abort(MPI_COMM_WORLD,0))
#define MPI_Scatterv(sendbuf,sendcounts,displs,\
     sendtype, recvbuf,recvcount,\
     recvtype,root,comm) \
     (MPIUNI_TMP = (void*)( (ESMC_I8)) (sendbuf),\
     MPIUNI_TMP = (void*)( (ESMC_I8)) (sendcounts),\
     MPIUNI_TMP = (void*)( (ESMC_I8)) (displs),\
     MPIUNI_TMP = (void*)( (ESMC_I8)) (sendtype),\
     MPIUNI_TMP = (void*)( (ESMC_I8)) (recvbuf),\
     MPIUNI_TMP = (void*)( (ESMC_I8)) (recvcount),\
...
#define MPI_Reduce(sendbuf, recvbuf,count,\
     ...
     MPIUNI_TMP = (void*)( (ESMC_I8)) (comm),MPI_SUCCESS)
...
#define MPI_Comm_compare(comm1,comm2,result) \
     (MPIUNI_TMP = (void*)( (ESMC_I8)) (comm1),\
     MPIUNI_TMP = (void*)( (ESMC_I8)) (comm2),\
     *(result)=MPI_IDENT,\
     MPI_SUCCESS)
...
#define MPI_Errhandler_create(function,errhandler) \
     (MPIUNI_TMP = (void*)( (ESMC_I8)) (errhandler),\
     MPI_SUCCESS)
