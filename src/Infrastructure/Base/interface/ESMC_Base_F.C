// $Id: ESMC_Base_F.C,v 1.35 2005/01/13 22:40:48 nscollins Exp $
//
...
//-----------------------------------------------------------------------------
 ...
 static const char *const version = "$Id: ESMC_Base_F.C,v 1.35 2005/01/13 22:40:48 nscollins Exp $";
//-----------------------------------------------------------------------------
...
//EOPI
  ...
  status = (*base)->ESMC_BaseSetVMId(*vmid);
  if (rc) *rc = status;
