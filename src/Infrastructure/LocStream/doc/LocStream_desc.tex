...
represented using a construct called {\it keys}. 

Keys are essentially vectors for point descriptors.  They may include 
...
as there are observations.  Keys may be used for the distribution of 
LocStreams.  As such, they must be defined before the LocStream is 
distributed.
...
LocStreams can be created from file, depending on file format.

Common operations involving LocStreams are similar to those involving Grids.
In data assimilation, for example, LocStreams allow users to:
