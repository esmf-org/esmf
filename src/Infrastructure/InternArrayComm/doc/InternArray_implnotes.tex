% $Id: InternArray_implnotes.tex,v 1.2 2007/06/22 23:21:34 cdeluca Exp $
...
Fortran code in Fields, InternGrids, Route, and Regrid to refer to data 
...
compiled and used by InternGrid, Field, and Bundle code before the communication
code has been compiled.  

The Array communication routines require InternGrid and DataMap information in 
addition to the Array itself.   The ArrayDataMap is needed to identify which
axes in the Array correspond to InternGrid axes.  The InternGrid is needed to compute
