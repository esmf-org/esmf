% $Id: Grid_desc.tex,v 1.16 2007/05/23 15:30:40 cdeluca Exp $
%
...
using this call and specifying connectivities using the
...
\label{table:Shapes}
\hline
& {\bf connDim1(1)} & {\bf connDim1(2)}  & {\bf connDim2(1)} & {\bf connDi\m2(2)}  \\
\hline
...
\caption{Types of decompositions.  Block and regular decompositions for
a 6x6 matrix {\bf a}, and arbitrary decomposition for a 6x3 matrix {\bf b}.}
...
argument is required when ESMF_GridCreateEmpty() is used to initiate
Grid creation.
