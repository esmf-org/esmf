! $Id: ESMF_Grid.F90,v 1.1 2007/05/11 15:53:40 oehmke Exp $
!
...
! !INTERFACE:
  ! Private name; call using ESMF_GridCreate()
      function ESMF_GridCreateFromExtents(name,arrayspec, minIndex,maxIndex, dimmap, &
...
! !INTERFACE:
  ! Private name; call using ESMF_GridCreate()
      function ESMF_GridCreateFromDistGrid(name,arrayspec,distgrid, dimmap, &
...
! \item[{[arrayspec]}] 
!     {\tt ESMF\_ArraySpec} object containing the type/kind/rank information.
!     If not specified then the grid will be of rank distgrid.dimCount+size(ubounds),
!     and the type/kind will be {\tt ESMF\_R8}. 
! \item[distgrid]
...
! !INTERFACE:
      subroutine ESMF_GridCommit(grid, rc)
!
! !ARGUMENTS:
