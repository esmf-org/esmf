! $Id: ESMF_FieldBundleUTest.F90,v 1.1.2.2 2008/04/04 16:17:26 theurich Exp $
!
...
!      call ESMF_FieldBundleGetAttributeCount(bundle2, count, rc=rc)
!      write(failMsg, *) "Did not return ESMF_RC_OBJ_DELETED"
...
!      call ESMF_FieldBundleGetAttributeCount(bundle1, count, rc=rc)
!      write(failMsg, *) "Did not return ESMF_RC_OBJ_NOT_CREATED"
...
!      call ESMF_FieldBundleSetAttribute(bundle1, name="Sides", value=65, rc=rc)
!      write(failMsg, *) "Did not return ESMF_SUCCESS"
...
!      call ESMF_FieldBundleGetAttribute(bundle1, name="Sides", value=number, rc=rc)
...
!                      name, failMsg, result, ESMF_SRCLINE)
      ...
      !EX_removeUTest
      ! Get an integer attribute from a FieldBundle Test
!      call ESMF_FieldBundleGetAttributeInfo(bundle1, name="Sides", count=number, rc=rc)
!      write(failMsg, *) "Did not return ESMF_SUCCESS or wrong value"
