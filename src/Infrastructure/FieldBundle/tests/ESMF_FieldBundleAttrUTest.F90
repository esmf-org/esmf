! $Id: ESMF_FieldBundleAttrUTest.F90,v 1.3 2008/04/05 03:38:21 cdeluca Exp $
!
...
!==============================================================================
!
program ESMF_FieldBundleAttrUTest
...
!==============================================================================
!BOP
! !PROGRAM: ESMF_FieldBundleAttrTest - FieldBundle Attribute Unit Tests
!
! !DESCRIPTION:
!
! The code in this file drives F90 FieldBundle Attribute unit tests.
...
!-------------------------------------------------------------------------------
  ...
  !-----------------------------------------------------------------------------
      ...
      !------------------------------------------------------------------------
      ! preparations
      bundle1 = ESMF_FieldBundleCreate(name="bundle 1", rc=rc)
...
end program ESMF_FieldBundleAttrUTest
