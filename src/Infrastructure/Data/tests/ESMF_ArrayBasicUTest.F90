    ...
    array1 = ESMF_LocalArrayCreate(intptr, rc=rc)
    !array1 = ESMF_LocalArrayCreate(intptr, docopy, rc)
    print *, "array 1 create returned"
 
    call ESMF_LocalArrayPrint(array1, "opts", rc)
    print *, "array print returns"

    call ESMF_LocalArrayGetData(array1, intptr2, docopy, rc)
