// $Id: ESMCI_Container_F.C,v 1.1 2011/04/12 00:15:40 theurich Exp $
//
...
extern "C" {
  ...
  void FTN(c_esmc_containercreate)(ESMCI::Container<std::string, void *> **ptr,
    int *rc){
#undef  ESMC_METHOD
#define ESMC_METHOD "c_esmc_containercreate()"
    ...
    try{
      // call into C++
      *ptr = new ESMCI::Container<std::string, void *>;
    }catch(int localrc){
  ...
  void FTN(c_esmc_containerdestroy)(ESMCI::Container<std::string, void *> **ptr,
    int *rc){
#undef  ESMC_METHOD
