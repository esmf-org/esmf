% $Id: LogErr_usage.tex,v 1.23 2006/01/05 00:38:33 eschwab Exp $
...
{\tt logtype} property in the {\tt ESMF\_LogInitialize()} or 
...
The results are all put into the default Log file {\tt PET0.ESMF\_LogFile}.

The next example shows same messages running with the {\tt logtype} 
