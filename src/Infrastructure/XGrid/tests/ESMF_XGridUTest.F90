! $Id: ESMF_XGridUTest.F90,v 1.18 2011/01/05 20:05:46 svasquez Exp $
!
...
! The following line turns the CVS identifier string into a printable variable.
    ...
    call test4(rc)
    write(failMsg, *) ""
    write(name, *) "Creating an XGrid with area/centroid, variable src flux"
    call ESMF_Test((rc.eq.ESMF_SUCCESS), name, failMsg, result, ESMF_SRCLINE)
    ...
    call test5(rc)
    write(failMsg, *) ""
    write(name, *) "Similar to test4 but using FieldRegrid through xgrid API"
    call ESMF_Test((rc.eq.ESMF_SUCCESS), name, failMsg, result, ESMF_SRCLINE)
