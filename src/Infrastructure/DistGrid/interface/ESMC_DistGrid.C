// $Id: ESMC_DistGrid.C,v 1.3 2008/03/05 05:50:40 theurich Exp $
//
...
static const char *const version = "$Id: ESMC_DistGrid.C,v 1.3 2008/03/05 05:50:40 theurich Exp $";
//-----------------------------------------------------------------------------
...
#define ESMC_METHOD "ESMC_DistGridCreate()"
  ...
  distgrid.ptr = (void *)
    ESMCI::DistGrid::create(minIndexInterface, maxIndexInterface, NULL,
      NULL, 0, NULL, NULL, NULL, NULL, (ESMCI::DELayout*)NULL, NULL, &localrc);
