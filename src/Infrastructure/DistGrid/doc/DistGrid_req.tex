% $Id: DistGrid_req.tex,v 1.18 2002/05/15 22:22:00 cnh Exp $
...
\begin{reqlist}
\item[Priority] 1
\item[Source] CAM-FV, NSIPP, CAM-EUL, CLM, CCSM-CPL, NCEP-GSM, NCEP-SSI, MIT \\
\item[Status]
\item[Verification]
...
\begin{reqlist}
\item[Priority] 1
\item[Source] CAM-FV, NSIPP, CAM-EUL, CLM, CCSM-CPL, POP, CICE, NCEP-GSM, NCEP-SSI, MIT \\
\item[Status]
\item[Verification]
...
\begin{reqlist}
\item[Priority] 1
\item[Source] CAM-FV (2D decomposition), NSIPP, CAM-EUL, CLM, CCSM-CPL, POP, MIT \\
\item[Status]
\item[Verification]
...
\begin{reqlist}
\item[Priority] 1
\item[Source] CAM-FV, CAM-EUL, CLM, CCSM-CPL, POP, CICE, NCEP-GSM, NCEP-SSI, MIT
\item[Status]
\item[Verification]
...
\item[Status]
\item[Verification]
\item[Notes] This would be very useful. Why doesn;t anybody want it? - CNH
\end{reqlist}
...
\begin{reqlist}
\item[Priority] 1
\item[Source] CAM-FV, CAM-EUL, CLM, CCSM-CPL, POP, CICE, MIT
\item[Status]
\item[Verification]
...
\begin{reqlist}
\item[Priority] 1
\item[Source] CAM-FV, NSIPP, CAM-EUL, CLM, CCSM-CPL, POP, CICE, MIT
\item[Status]
\item[Verification]
\item[Notes]
\end{reqlist}
...
\begin{reqlist}
\item[Priority] 1
\item[Source] NCEP-GSM, NCEP-SSI, MIT
\item[Status]
\item[Verification]
\item[Notes]
\end{reqlist}
...
\begin{reqlist}
\item[Priority] 
\item[Source] CAM-EUL, CLM, CCSM-CPL, POP, CICE, NCEP-GSM, NCEP-SSI, MIT
\item[Status]
\item[Verification]
\item[Notes]
\end{reqlist}
...
\begin{reqlist}
\item[Priority]
\item[Source] CCSM-CPL, POP, CICE, NCEP-GSM, NCEP-SSI, MIT
\item[Status]
\item[Verification]
\item[Notes]
\end{reqlist}
...
\begin{reqlist}
\item[Priority]
\item[Source] CCSM-CPL, POP, CICE, MIT
\item[Status]
\item[Verification]
\item[Notes] Besides being able to retrieve one's own domain
  information, the full list of domains is also required for certain
...
\begin{reqlist}
\item[Priority]
\item[Source] CCSM-CPL, POP, CIC, MIT
\item[Status]
\item[Verification]
...
\begin{reqlist}
\item[Priority]
\item[Source] CCSM-CPL, MIT
\item[Status]
\item[Verification]
\item[Notes] Application here means "ESMF application"? - CNH
\end{reqlist}
...
\begin{reqlist}
\item[Priority] 1
\item[Source] CAM-FV, NSIPP, NCEP-SSI, MIT
\item[Status]
\item[Verification]
...
\begin{reqlist}
\item[Priority]
\item[Source] CAM-EUL, CLM, CCSM-CPL, POP, CICE, MIT
\item[Status]
\item[Verification]
...
\begin{reqlist}
\item[Priority] 1
\item[Source] CAM-FV, NCEP-SSI, MIT
\item[Status]
\item[Verification]
\item[Notes]
\end{reqlist}
...
\begin{reqlist}
\item[Priority]
\item[Source] POP (desired), CICE (desired), MIT
\item[Status]
\item[Verification]
...
\begin{reqlist}
\item[Priority] 1
\item[Source] CAM-FV (2D decomposition), NSIPP, NCEP-GSM, NCEP-SSI, MIT
\item[Status]
\item[Verification]
\item[Notes] maybe we're pre-empting design issues, but I'd want
  issues like wait-for-completion dealt with within \textbf{DistGrid}.
...
\begin{reqlist}
\item[Priority] 1
\item[Source] CAM-FV (2D decomposition), POP, MIT
\item[Status]
\item[Verification]
\item[Notes] 
\end{reqlist}
...
\begin{reqlist}
\item[Priority] 1
\item[Source] CAM-FV (2D decomposition), NSIPP, MIT
\item[Status]
\item[Verification]
\item[Notes] 
\end{reqlist}
...
\begin{reqlist}
\item[Priority] 1
\item[Source] trace to GR. CAM-EUL, CLM, NCEP-GSM, NCEP-SSI, MIT
\item[Status]
\item[Verification]
...
\sreq{Adjoints of all sums except checksum are reuqired}
...
\begin{reqlist}
\item[Priority] 1
\item[Source] CAM-FV, CAM-EUL, CLM, CCSM-CPL, MIT
\item[Status]
\item[Verification]
\item[Notes]
\end{reqlist}
...
\begin{reqlist}
\item[Priority] 1
\item[Source] PSAS, NSIPP, NCEP-SSI (milestone), MIT(assimilation  and lagrangian diagnostics)
\item[Status]
\item[Verification]
