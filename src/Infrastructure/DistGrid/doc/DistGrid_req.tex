% $Id: DistGrid_req.tex,v 1.24 2002/06/04 21:27:11 rhallberg Exp $
...
\begin{reqlist}
{\bf Priority:} 1. \\ 
{\bf Source:} CAM-EUL, CLM, CCSM-CPL, POP, CICE, NCEP-GSM, NCEP-SSI, MIT, GFDL. \\
{\bf Status:} Approved-1. \\
{\bf Verification:} Unit test.\\
{\bf Notes:}
\end{reqlist}
...
\begin{reqlist}
{\bf Priority:} 3 \\
{\bf Source:} POP (desired), CICE (desired), MIT (desired), GFDL (desired). \\
{\bf Status:} Approved-2. \\
{\bf Verification:} \\
...
\begin{reqlist}
{\bf Priority:} 1. \\
{\bf Source:} CAM-FV (2D decomposition), NSIPP, CAM-EUL, CLM, CCSM-CPL, POP, MIT, GFDL \\
{\bf Status:} Approved-2. \\
{\bf Verification:} Unit test. \\
...
\begin{reqlist}
{\bf Priority:} 3 \\
{\bf Source:} MIT (desired), GFDL (desired) \\
{\bf Status:} Approved-2. \\
{\bf Verification:} Unit test. \\
