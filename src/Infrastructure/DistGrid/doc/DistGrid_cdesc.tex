% $Id: DistGrid_cdesc.tex,v 1.3 2011/01/07 18:32:16 rokuingh Exp $
%
...
rectangular (LR) sub-domains or {\em tilees}. The DistGrid create methods allow
...
connection relationships between tilees during creation.
