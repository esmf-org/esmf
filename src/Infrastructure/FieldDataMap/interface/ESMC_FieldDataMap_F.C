// $Id: ESMC_FieldDataMap_F.C,v 1.10 2007/06/23 04:00:28 cdeluca Exp $
//
...
//
      ...
      type ESMF_ArrayDataMap
        ...
        integer, dimension(ESMF_MAXDIM) :: dataNonIGridCounts ! for non-igrid
...
void FTN(c_esmc_arraydatamapserialize)(int *status, int *dataRank,
    ...
    if ((*length - *offset) < fixedpart) {
         ...
         ESMC_LogDefault.ESMC_LogMsgFoundError(ESMC_RC_ARG_BAD,
                         "Buffer too short to add a DataMap object", rc);
         return;
