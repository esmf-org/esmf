% $Id: HW_Monitor_design.tex,v 1.1 2002/11/13 23:30:21 ekluz Exp $
%
...
The HW\_Monitor class uses Hardware monitoring libraries (PCL or PAPI)
...
The HW\_Monitor class is meant to be created by the InstrumentedSegment
class. There are three important methods for HW\_Monitor: Init, BeginMonitoring,
