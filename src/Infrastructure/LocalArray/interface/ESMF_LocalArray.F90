! $Id: ESMF_LocalArray.F90,v 1.2 2003/09/22 17:50:46 nscollins Exp $
!
            ...
            select case (rank)
              case (1)
                select case (localkind)
                  case (ESMF_I2%dkind)
                    call ESMF_LocalArrConstrF90PtrI21D(array, counts, rc=status)
                  case (ESMF_I4%dkind)
              ...
              case (2)
                select case (localkind)
                  case (ESMF_I2%dkind)
                    call ESMF_LocalArrConstrF90PtrI22D(array, counts, rc=status)
                  case (ESMF_I4%dkind)
              ...
              case (3)
                select case (localkind)
                  case (ESMF_I2%dkind)
                    call ESMF_LocalArrConstrF90PtrI23D(array, counts, rc=status)
                  case (ESMF_I4%dkind)
              ...
              case (4)
                select case (localkind)
                  case (ESMF_I2%dkind)
                    call ESMF_LocalArrConstrF90PtrI24D(array, counts, rc=status)
                  case (ESMF_I4%dkind)
              ...
              case (5)
                select case (localkind)
                  case (ESMF_I2%dkind)
                    call ESMF_LocalArrConstrF90PtrI25D(array, counts, rc=status)
                  case (ESMF_I4%dkind)
...
! <Created by macro - do not edit directly > 
 ...
 call c_ESMC_LocalArraySetInfo(array, localI25D, & 
...
! <Created by macro - do not edit directly > 
 ...
 call c_ESMC_LocalArraySetInfo(array, localI45D, & 
...
! <Created by macro - do not edit directly > 
 ...
 call c_ESMC_LocalArraySetInfo(array, localI85D, & 
...
! <Created by macro - do not edit directly > 
 ...
 call c_ESMC_LocalArraySetInfo(array, localR45D, & 
...
! <Created by macro - do not edit directly > 
 ...
 call c_ESMC_LocalArraySetInfo(array, localR85D, & 
