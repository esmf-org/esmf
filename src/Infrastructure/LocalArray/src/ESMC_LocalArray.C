// $Id: ESMC_LocalArray.C,v 1.34 2008/07/29 01:34:52 rosalind Exp $
//
...
static const char *const version = "$Id: ESMC_LocalArray.C,v 1.34 2008/07/29 01:34:52 rosalind Exp $";
//-----------------------------------------------------------------------------
...
//
    ...
    if (rank > 7) {
        ...
        printf(msgbuf);
        ESMC_LogDefault.Write(msgbuf, ESMC_LOG_ERROR);
