...
extern "C" {
  ...
  void FTN_X(c_esmc_pointlistcreatefrmgrid)(ESMCI::Grid **gptr, ESMC_StaggerLoc *staggerLoc, ESMCI::InterfaceInt *maskValuesArg, ESMCI::PointList **plptr, int *rc){
#undef  ESMC_METHOD
#define ESMC_METHOD "c_esmc_pointlistcreatefrmgrid()"
  ...
  void FTN_X(c_esmc_pointlistcreatefrmmesh)(ESMCI::MeshCap **mptr, ESMC_MeshLoc_Flag *meshLoc, ESMCI::InterfaceInt *maskValuesArg, ESMCI::PointList **plptr, int *rc){
#undef  ESMC_METHOD
