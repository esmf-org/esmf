...
ignored during an operation.  See \ref{regrid:masking} for an explanation 
of how masking works in regridding.

ESMF currently supports masking for Fields built on structured 
Grids.  To do masking the user sets
mask information in the Grid, as described here \ref{sec:usage:items}.
