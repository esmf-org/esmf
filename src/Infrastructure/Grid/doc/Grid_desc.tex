% $Id: Grid_desc.tex,v 1.21 2006/01/23 23:30:00 cdeluca Exp $
%
...
\begin{center}
\begin{figure}
\scalebox{0.66}{\includegraphics{GridDataLocations}}
...
% \scalebox{0.66}{\includegraphics{ArakawaC_SE}}
% \end{figure}
% \end{center}
...
% \scalebox{0.66}{\includegraphics{VertGridDataLocations}}
% \end{figure}
% \end{center}
...
% \scalebox{0.66}{\includegraphics{GridBlockDistribution}}
% \end{figure}
% \end{center}
...
% \scalebox{0.66}{\includegraphics{GridArbitraryDistribution}}
% \end{figure}
% \end{center}
