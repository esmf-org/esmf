% $Id: Grid_options.tex,v 1.24.2.1 2008/03/19 21:18:01 oehmke Exp $
...
The 2D predefined stagger locations (illustrated in figure~\ref{gridstaggerloc2d}) are:\\
\begin{description}
...
\begin{center}
\begin{figure}
\scalebox{0.75}{\includegraphics{GridStaggerLoc3D_top}}
\caption{3D Predefined Stagger Locations - Cell Top}
\label{fig:gridstaggerloc3dtop}
\end{figure}
\end{center}

\begin{center}
\begin{figure}
\scalebox{0.75}{\includegraphics{GridStaggerLoc3D_mid}}
\caption{3D Predefined Stagger Locations - Cell Middle}
\label{fig:gridstaggerloc3dmid}
\end{figure}
\end{center}

\begin{center}
\begin{figure}
\scalebox{0.75}{\includegraphics{GridStaggerLoc3D_btm}}
\caption{3D Predefined Stagger Locations - Cell Bottom}
\label{fig:gridstaggerloc3dbtm}
\end{figure}
\end{center}


The 3D predefined stagger locations (illustrated in figures~\ref{gridstaggerloc3dtop}~,~\ref{gridstaggerloc3dmid},~and~\ref{gridstaggerloc3dbtm}) are:\\
\begin{description}
