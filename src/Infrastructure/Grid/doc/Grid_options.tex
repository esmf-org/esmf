% $Id: Grid_options.tex,v 1.24.2.3 2008/03/31 17:37:41 oehmke Exp $
...
\begin{center}
\begin{figure}
\scalebox{1.25}{\includegraphics{GridStaggerLoc3D}}
\caption{3D Predefined Stagger Locations}
\label{fig:gridstaggerloc3d}
\end{figure}
\end{center}

The 3D predefined stagger locations (illustrated in figure~\ref{gridstaggerloc3d}) are:\\
\begin{description}
