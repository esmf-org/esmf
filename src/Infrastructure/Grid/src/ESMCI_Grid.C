// $Id: ESMCI_Grid.C,v 1.36.2.1 2008/02/24 05:45:53 oehmke Exp $
//
...
static const char *const version = "$Id: ESMCI_Grid.C,v 1.36.2.1 2008/02/24 05:45:53 oehmke Exp $";
//-----------------------------------------------------------------------------
...
//-----------------------------------------------------------------------------
 ...
 // Rename Grid UndistLBound, UndistUBound to distinguish them from the Array versions 
  ...
  for (coord=0; coord<dimCount; coord++) {
    ...
    arrayspec->ESMC_ArraySpecSetRank(coordDimCount[coord]);
