% $Id: TimeMgr_desc.tex,v 1.10 2003/08/15 17:37:26 cdeluca Exp $
...
Time.  See Sections~\ref{sec:Time} and {sec:TimeInterval}, respectively,
...
interfaces to these classes are defined so that you can specify a time
using as a combination of time units selected from the list shown in 
