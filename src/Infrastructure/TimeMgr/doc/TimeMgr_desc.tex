% $Id: TimeMgr_desc.tex,v 1.19 2004/09/13 18:15:25 eschwab Exp $
...
calendars includes:
\begin{description}
\item [Gregorian] The standard Gregorian calendar, proleptic to 3/1/-4800.
...
\item [no calendar] Tracks only elapsed model time in seconds.
\end{description}
