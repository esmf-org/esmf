! $Id: ESMF_BaseTime.F90,v 1.10 2003/08/29 05:31:58 eschwab Exp $
!
...
!     ! Equivalent sequence and kind to C++:
      ...
      private
        ...
        integer(ESMF_IKIND_I4) :: sN    ! fractional seconds, numerator
        integer(ESMF_IKIND_I4) :: sD    ! fractional seconds, denominator
