// $Id: ESMCI_Time.C,v 1.18.2.1 2012/01/06 20:44:59 svasquez Exp $"
//
...
//-------------------------------------------------------------------------
 ...
 static const char *const version = "$Id: ESMCI_Time.C,v 1.18.2.1 2012/01/06 20:44:59 svasquez Exp $";
//-------------------------------------------------------------------------
...
// !REQUIREMENTS:  
 ...
 #define ESMC_METHOD "ESMCI::Time::isLeapYear()"
    ...
    if (ESMC_LogDefault.MsgFoundError(rc2, ESMCI_ERR_PASSTHRU, rc)) {
      return(false);
    }
