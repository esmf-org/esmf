// $Id: ESMC_Clock.C,v 1.70.2.1 2005/02/08 23:46:06 eschwab Exp $
//
...
//-------------------------------------------------------------------------
 ...
 static const char *const version = "$Id: ESMC_Clock.C,v 1.70.2.1 2005/02/08 23:46:06 eschwab Exp $";
//-------------------------------------------------------------------------
...
// !REQUIREMENTS:  
 ...
 #define ESMC_METHOD "ESMC_ClockCreate(new)"
    ...
    // This does not break the lower limit of the Fliegel algorithm (for
    //   Gregorian or Julian Day calendars) since that is based on
    //   whole seconds.
