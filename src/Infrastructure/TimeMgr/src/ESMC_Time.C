// $Id: ESMC_Time.C,v 1.37 2003/06/04 20:07:45 nscollins Exp $
//
...
//-------------------------------------------------------------------------
 ...
 static const char *const version = "$Id: ESMC_Time.C,v 1.37 2003/06/04 20:07:45 nscollins Exp $";
//-------------------------------------------------------------------------
...
// !REQUIREMENTS:  
    ...
    ESMC_TimeSet(&YR, &MM, &DD, ESMC_NULL_POINTER, &H, &M, &S);
