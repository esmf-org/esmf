! $Id: ESMF_CalRangeEx.F90,v 1.1 2003/04/24 05:31:35 eschwab Exp $
!
...
!------------------------------------------------------------------------------
      ...
      !
      ! find low range end point of Fliegel algorithm 
      !
      D = 0
      print *, "Check Start Days = ", D
