! $Id: ESMF_TimeIntervalEx.F90,v 1.8 2003/07/28 20:10:32 svasquez Exp $
!
...
!------------------------------------------------------------------------------
      ...
      call ESMF_TimeIntervalSet(timeInterval1, d_i4=1, &
                                s_i4=1800, rc=rc)

      ! initialize time interval2 to 4 days, 5400 seconds (1.5 hours)
      call ESMF_TimeIntervalSet(timeInterval2, d_i4=4, &
                                s_i4=5400, rc=rc)

      call ESMF_TimeIntervalGet(timeInterval1, d_i4=D, h_i4=H, m_i4=M, rc=rc)
      print *, "Time Interval1 = ", D, " days, ", H, " hours, ", M, " minutes."
      call ESMF_TimeIntervalPrint(timeInterval1, "string", rc)

      call ESMF_TimeIntervalGet(timeInterval2, d_i4=D, h_i4=H, m_i4=M, rc=rc)
      ...
      call ESMF_TimeIntervalGet(timeInterval3, d_i4=D, s_i4=S, rc=rc)
      ...
      call ESMF_TimeIntervalGet(timeInterval3, d_i4=D, h_i4=H, m_i4=M, s_i4=S, rc=rc)
