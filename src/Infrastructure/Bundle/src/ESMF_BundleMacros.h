...
#define BundleInterfaceMacro(funcname) \
!------------------------------------------------------------------------------ @\
...
!BOP @\
! !IROUTINE: ESMF_BundleGetDataPointer##mtypekind##mrank##D - Retrieve F90 pointer directly from a Bundle @\
 @\
! !INTERFACE: @\
      subroutine ESMF_BundleGetDataPointer##mtypekind##mrank##D(bundle, fieldname, f90ptr, copyflag, rc) @\
! @\
! !ARGUMENTS: @\
...
! !REQUIREMENTS: @\
 ...
 @\
        end subroutine ESMF_BundleGetDataPointer##mtypekind##mrank##D   @\
 @\
! < end macro - do not edit directly >  @\
!------------------------------------------------------------------------------ @\
