...
! !INTERFACE:
      subroutine ESMF_RegridRunR8(srcarray, dstarray, srcDataMap, dstDataMap, &
                                  routehandle, rc)
!
! !ARGUMENTS:
...
! !REQUIREMENTS:
      ...
      elseif (srcKind.eq.ESMF_R8 .AND. dstKind.eq.ESMF_R8) then
        call ESMF_RegridRunR8(srcarray, dstarray, srcDataMap, dstDataMap, &
                              routehandle, localrc)
      else
