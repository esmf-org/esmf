...
\includegraphics{RegridScaling.tiff}
\end{figure}
\end{center}
...
\includegraphics{ParallelRegrid.tiff}
\end{figure}
\end{center}
...
\includegraphics{RToCRegrid.tiff}
\end{figure}
\end{center}
...
\includegraphics{RegridIntersection.tiff}
\end{figure}
\end{center}
...
\includegraphics{RegridExtraLayer.tiff}
\end{figure}
\end{center}
...
\includegraphics{TargetBinSize.tiff}
\end{figure}
\end{center}
