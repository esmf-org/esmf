! $Id: ESMF_Regrid2UTest.F90,v 1.2 2005/05/23 17:24:05 svasquez Exp $
!
...
!==============================================================================
!
    program ESMF_FieldRegrid2UTest
...
!==============================================================================
!BOC
! !PROGRAM: ESMF_FieldRegrid2UTest - Using the Regridding methods
!
! !DESCRIPTION:
!
...
!    ! Cleanup
    ...
    end program ESMF_FieldRegrid2UTest
