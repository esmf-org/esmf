...
!==============================================================================
    ...
    program ESMF_RegridFunctionUTest
...
!==============================================================================
!BOC
! !PROGRAM: ESMF_RegridFunctionUTest - Using the Regridding methods
!
! !DESCRIPTION:
!
...
! The following line turns the CVS identifier string into a printable variable.
      ...
      '$Id: ESMF_RegridFunctionUTest.F90,v 1.1 2005/10/21 17:25:08 svasquez Exp $'
!------------------------------------------------------------------------------
...
!    ! Cleanup
    ...
    end program ESMF_RegridFunctionUTest
