% $Id: IO_background.tex,v 1.11 2002/05/09 22:44:17 lzaslavsky Exp $
...
A {\em self-described} file contains in its header all metadata necessary to 
provide a unique interpretation of the file content assuming certain 
conventions.  A {\em co-described} file is accompanied by a metadata file. The
