% $Id: IO_background.tex,v 1.29 2010/10/01 05:59:57 eschwab Exp $
...
\htmladdnormallink{Parallel I/O (PIO)}{http://web.ncar.teragrid.org/~dennis/pio\_doc/html} library developed as a collaboration between NCAR and DOE 
...
In the current release, the following methods support parallel I/O using PIO:
...
Two formats are supported, namely, NetCDF and binary (MPI\_IO). 
...
set to "standard" to enable NetCDF IO format.  Details about the environment 
