% $Id: IO_req.tex,v 1.10 2002/05/12 00:58:43 tcraig Exp $
...
\begin{reqlist}
{\bf Priority:} 1 \\
{\bf Source:} DAO, NCEP, CAM-EUL, CLM, CCSM-CPL \\
{\bf Status:} Proposed \\
...
\begin{reqlist}
{\bf Priority:} 2 \\
{\bf Source:} DAO, NSIPP, CAM-EUL, CLM, CCSM-CPL \\
{\bf Status:} Proposed \\
{\bf Verification:} Unit test. \\
...
\begin{reqlist}
{\bf Priority:} 1 \\
{\bf Source:} NCEP, DAO, NSIPP, CAM-EUL, CLM, CCSM-CPL \\
{\bf Status:} Proposed \\
{\bf Verification:} Unit test.
