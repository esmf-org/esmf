...
void FTN_X(pio_cpp_finalize)(pio_iosystem_desc_t *iosystem,
                             int* ierror);
...
void FTN_X(pio_cpp_initdecomp_dof_io)(pio_iosystem_desc_t *iosystem,
                                      int basepiotype,
                                      int* dims, int ndims,
...
void FTN_X(pio_cpp_initdecomp_dof)(pio_iosystem_desc_t *iosystem,
                                   int basepiotype,
                                   int* dims, int ndims,
                                   pio_dof_t* compdof, int ncompdof,
                                   pio_io_desc_t iodesc);
...
void FTN_X(pio_cpp_initdecomp_dof_dof)(pio_iosystem_desc_t *iosystem,
                                       int basepiotype,
                                       int* dims, int ndims,
...
int FTN_X(pio_cpp_openfile)(pio_iosystem_desc_t *iosystem,
...
void FTN_X(pio_cpp_syncfile)(pio_file_desc_t file);

// function pio_cpp_createfile(iosystem, file, iotype, fname, amode_in)       &
//          result(ierr) bind(c)

int FTN_X(pio_cpp_createfile)(pio_iosystem_desc_t *iosystem,
                              pio_file_desc_t file,
                              int iotype,
                              const char *fname,
                              int amode_in);
...
void FTN_X(pio_cpp_closefile)(pio_file_desc_t file);

// subroutine pio_cpp_setiotype(file, iotype, rearr) bind(c)

void FTN_X(pio_cpp_setiotype)(pio_file_desc_t file,
                              int iotype,
                              int rearr);

// function pio_cpp_numtoread(iodesc) result(num) bind(c)

int FTN_X(pio_cpp_numtoread)(pio_io_desc_t iodesc);

// function pio_cpp_numtowrite(iodesc) result(num) bind(c)

int FTN_X(pio_cpp_numtowrite)(pio_io_desc_t iodesc);

// subroutine pio_cpp_setframe(vardesc, frame) bind(c)

void FTN_X(pio_cpp_setframe)(pio_var_desc_t vardesc,
                             int frame);

// subroutine pio_cpp_advanceframe(vardesc) bind(c)

void FTN_X(pio_cpp_advanceframe)(pio_var_desc_t vardesc);

// subroutine pio_cpp_setdebuglevel(level) bind(c)

void FTN_X(pio_cpp_setdebuglevel)(int level);

// subroutine pio_cpp_seterrorhandlingf(file, method) bind(c)

void FTN_X(pio_cpp_seterrorhandlingf)(pio_file_desc_t file,
                                      int method);

// subroutine pio_cpp_seterrorhandlingi(ios, method) bind(c)

void FTN_X(pio_cpp_seterrorhandlingi)(void* ios,
                                      int method);

// function pio_cpp_get_local_array_size(iodesc) result(siz) bind(c)

int FTN_X(pio_cpp_get_local_array_size)(pio_io_desc_t iodesc);

// subroutine pio_cpp_freedecomp_ios(ios_handle, iodesc) bind(c)

void FTN_X(pio_cpp_freedecomp_ios)(void* ios,
                                   pio_io_desc_t iodesc);

// subroutine pio_cpp_freedecomp_file(file, iodesc) bind(c)

void FTN_X(pio_cpp_freedecomp_file)(pio_file_desc_t file,
                                    pio_io_desc_t iodesc);

// subroutine pio_cpp_dupiodesc(src, dest) bind(c)

void FTN_X(pio_cpp_dupiodesc)(void* src,
                              void* dest);

// subroutine pio_cpp_getnumiotasks(iosystem, numiotasks) bind(c)

void FTN_X(pio_cpp_getnumiotasks)(pio_iosystem_desc_t *iosystem,
                                  int* numiotasks);

// subroutine pio_cpp_set_hint(iosystem, hint, hintval) bind(c)

void FTN_X(pio_cpp_set_hint)(pio_iosystem_desc_t *iosystem,
                             void* hint,
                             void* hint_val);

// function pio_cpp_getnum_ost(iosystem) result(numost) bind(c)

int FTN_X(pio_cpp_getnum_ost)(pio_iosystem_desc_t *iosystem);

// subroutine pio_cpp_setnum_ost(iosystem, numost) bind(c)

void FTN_X(pio_cpp_setnum_ost)(pio_iosystem_desc_t *iosystem,
                               int numost);

// function pio_cpp_file_is_open(file) result(is_open) bind(c)

int FTN_X(pio_cpp_file_is_open)(pio_file_desc_t file);
...
int FTN_X(pio_cpp_enddef)(pio_file_desc_t file);

// function pio_cpp_redef(file) result(ierr) bind(c)

int FTN_X(pio_cpp_redef)(pio_file_desc_t file);

// function pio_cpp_def_var_0d(file, name, type, vardesc) result(ierr) bind(c)

int FTN_X(pio_cpp_def_var_0d)(pio_file_desc_t file,
                              const char *name,
                              int type,
                              pio_var_desc_t vardesc);
...
int FTN_X(pio_cpp_def_var_md)(pio_file_desc_t file,
                              const char *name,
                              int type,
...
int FTN_X(pio_cpp_copy_att)(pio_file_desc_t infile,
                            int invarid, const char *name,
...
void FTN_X(pio_cpp_read_darray_int)(void *file,
                                    void *varDesc,
                                    void *ioDesc,
                                    int *array,
                                    const int *shape,
...
void FTN_X(pio_cpp_read_darray_real)(void *file,
                                     void *varDesc,
                                     void *ioDesc,
                                     float *array,
                                     const int *shape,
...
void FTN_X(pio_cpp_read_darray_double)(void *file,
                                       void *varDesc,
                                       void *ioDesc,
                                       double *array,
                                       const int *shape,
...
void FTN_X(pio_cpp_write_darray_int)(void *file,
                                     void *varDesc,
                                     void *ioDesc,
                                     int *array,
                                     const int *shape,
...
void FTN_X(pio_cpp_write_darray_int_fill)(void *file,
                                          void *varDesc,
                                          void *ioDesc,
                                          int *array,
                                          const int *shape,
...
void FTN_X(pio_cpp_write_darray_real)(void *file,
                                      void *varDesc,
                                      void *ioDesc,
                                      float *array,
                                      const int *shape,
...
void FTN_X(pio_cpp_write_darray_real_fill)(void *file,
                                           void *varDesc,
                                           void *ioDesc,
                                           float *array,
                                           const int *shape,
...
void FTN_X(pio_cpp_write_darray_double)(void *file,
                                        void *varDesc,
                                        void *ioDesc,
                                        double *array,
                                        const int *shape,
...
void FTN_X(pio_cpp_write_darray_double_fill)(void *file,
                                             void *varDesc,
                                             void *ioDesc,
                                             double *array,
                                             const int *shape,
