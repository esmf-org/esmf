...
#else
        call piodie(_FILE_,__LINE__,'PIO was not built with -DUSEMPIIO')
#endif
     end if
...
!DBG     print *,'TEMPLATE_NAME(write_mpiio_): At the begining of subroutine: ',File%offset
     ...
     !-------------------------------------
     if(Debug) print *,_FILE_,__LINE__,' inside write_mpiio_int offset: ',File%offset
...
!DBG     print *,'TEMPLATE_NAME(write_mpiio_): At the begining of subroutine: ',File%offset
     ...
     ! Set file view for distributed array
     !-------------------------------------
     if(Debug) print *,_FILE_,__LINE__,' inside write_mpiio_real offset: ',File%offset
     call MPI_File_set_view(File%fh,File%offset, iodesc%Write%elemTYPE, iodesc%Write%fileTYPE, 'native',File%iosystem%info,ierr)
...
!DBG     print *,'TEMPLATE_NAME(write_mpiio_): At the begining of subroutine: ',File%offset
     ...
     ! Set file view for distributed array
     !-------------------------------------
     if(Debug) print *,_FILE_,__LINE__,' inside write_mpiio_double offset: ',File%offset
     call MPI_File_set_view(File%fh,File%offset, iodesc%Write%elemTYPE, iodesc%Write%fileTYPE, 'native',File%iosystem%info,ierr)
...
!DBG     if(Debug) print *,_FILE_,__LINE__,'IAM: ',File%iosystem%io_rank,' after set_view IODesc%Read%fileTYPE: ',iodesc%Read%fileTYPE
     ...
     if(Debug) print *,_FILE_,__LINE__,'IAM: ',File%iosystem%io_rank,'read_mpiio_text: cnt is: ',iodesc%Read%n_elemTYPE, cnt
     if(Debug) print *,_FILE_,__LINE__,'IAM: ',File%iosystem%io_rank,'read_mpio_text: reclen is: ',reclen
...
!DBG     if(Debug) print *,_FILE_,__LINE__,'IAM: ',File%iosystem%io_rank,' after set_view IODesc%Read%fileTYPE: ',iodesc%Read%fileTYPE
     ...
     if(Debug) call MPI_get_count(fstatus,iodesc%Read%elemTYPE,cnt,ierr)
     if(Debug) print *,_FILE_,__LINE__,'IAM: ',File%iosystem%io_rank,'read_mpiio_real: cnt is: ',iodesc%Read%n_elemTYPE, cnt
     if(Debug) print *,_FILE_,__LINE__,'IAM: ',File%iosystem%io_rank,'read_mpio_real: reclen is: ',reclen
...
!DBG     if(Debug) print *,_FILE_,__LINE__,'IAM: ',File%iosystem%io_rank,' after set_view IODesc%Read%fileTYPE: ',iodesc%Read%fileTYPE
     ...
     if(Debug) call MPI_get_count(fstatus,iodesc%Read%elemTYPE,cnt,ierr)
     if(Debug) print *,_FILE_,__LINE__,'IAM: ',File%iosystem%io_rank,'read_mpiio_double: cnt is: ',iodesc%Read%n_elemTYPE, cnt
     if(Debug) print *,_FILE_,__LINE__,'IAM: ',File%iosystem%io_rank,'read_mpio_double: reclen is: ',reclen
...
!DBG     if(Debug) print *,_FILE_,__LINE__,'IAM: ',File%iosystem%io_rank,' after set_view IODesc%Read%fileTYPE: ',iodesc%Read%fileTYPE
     ...
     if(Debug) call MPI_get_count(fstatus,iodesc%Read%elemTYPE,cnt,ierr)
     if(Debug) print *,_FILE_,__LINE__,'IAM: ',File%iosystem%io_rank,'read_mpiio_int: cnt is: ',iodesc%Read%n_elemTYPE, cnt
     if(Debug) print *,_FILE_,__LINE__,'IAM: ',File%iosystem%io_rank,'read_mpio_int: reclen is: ',reclen
