...
# 50 "pio_support.F90.in"
  subroutine piodie (file,line, msg, ival1, msg2, ival2, msg3, ival3, mpirank)
    ...
    !-----------------------------------------------------------------------
    ! $Id: pio_support.F90,v 1.9 2012/08/06 04:42:39 gold2718 Exp $
    !-----------------------------------------------------------------------
    !-----------------------------------------------------------------------
    implicit none
    !-----------------------------------------------------------------------
