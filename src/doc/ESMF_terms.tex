...
\item[Decomposition element (DE)] \label{glos:Decomp_Element}
  ...
  See also \htmlref{DELayout}{glos:DELayout}, \htmlref{PE}{glos:Process_Element}.
...
\item[PE list] \label{glos:PEList} A list of processor IDs associated 
  with a component.  See also \htmlref{layout}{glos:DELayout}, \htmlref{DE}{glos:Decomp_Element}.
...
\item[Processing element (PE)] \label{glos:Processing_Element}
  ...
  vendor-assigned ID.
  See also \htmlref{DE}{glos:Decomp_Element}.  
