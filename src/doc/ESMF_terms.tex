...
\item[Array] An ESMF class that represents a multi-dimensional
  data array.  Unlike a native Fortran or C++ array, an ESMF Array can store information about its halo.  See also \htmlref{halo}{glos:Halo}.
...
\item[Bundle] The ESMF Bundle class represents a set of fields that 
  ...
  See also \htmlref{Field}{glos:Field}, \htmlref{Packed Bundle}{glos:PackedBundle},
...
\item[Distributed Grid]
  ...
  See also \htmlref{Grid}{glos:Grid}, \htmlref{Physical Grid}{glos:PhysGrid},
...
\item[Physical Grid] 
  ...
  ESMF Grid.  See also \htmlref{Grid}{glos:Grid}, 
  \htmlref{Distributed Grid}{glos:DistGrid}.  
