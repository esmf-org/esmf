...
\item[Bundle] The ESMF Bundle class represents a set of fields that 
  ...
  dimensions.  See also \htmlref{Field}{glos:Field}, \htmlref{Packed Bundle}{glos:PackedBundle},
  \htmlref{Loose Bundle}{glos:LooseBundle}. 
...
are in the \htmladdnormallink{ESMF Project Plan}{http://www.esmf.ucar.edu/esmf\_pubs/paper\_0503\_projectplan.pdf}.
...
\htmladdnormallink{GRIB}{http://www.wmo.ch/web/www/WDM/Guides/Guide-binary-2.html} and
...
\item[Grid] 
  ...
  See also \htmlref{Physical Grid}{glos:PhysGrid}, \htmlref{Distributed Grid}
...
\item[Joint Specification Team(JST)]
  ...
  the JST is the weekly telecon.  Terms of Reference are in the \htmladdnormallink{ESMF Project Plan}{http://www.esmf.ucar.edu/esmf\_pubs/paper\_0503\_projectplan.pdf}.
...
\item[Loose Bundle] 
  ...
  \htmlref{packed Bundle}{glos:PackedBundle}.
...
\item[Rectilinear grid]
  ...
  coordinates in physical space can be fully specified by giving 
  the spacing of grid points along each grid axis.  The coordinates
  of each point in physical space are located where these 
  values intersect.  The spacing along each dimension may vary.
...
\label{glos:UniformGrid}
  ...
  grid point locations.  See also \htmlref{logically rectangular grid}{glos:LogRectGrid},
  \htmlref{Rectiliner grid}{glos:RectilinerGrid}, \htmlref{Curvilinear grid}
  {glos:CurvilinearGrid}.  
