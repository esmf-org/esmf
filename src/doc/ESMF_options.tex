% $Id: ESMF_options.tex,v 1.17.2.1 2007/06/07 18:01:52 theurich Exp $
...
\item [ESMF\_NONBLOCKING]
         ...
         operations have completed. Use the {\tt ESMF\_VMWait()} or
         {\tt ESMF\_VMWaitQueue()} method to block the local PET until
...
and functions which want to specify or query a data precision and type.
They cannot be used when declaring variables; see the
