% $Id: ESMF_options.tex,v 1.83 2012/09/12 17:49:03 gold2718 Exp $
...
\item [ESMF\_FILESTATUS\_UNKNOWN]
      The file is treated as if {\tt status} is 'OLD' if the
      file already exists. Otherwise, the file is treated as 'NEW'.
