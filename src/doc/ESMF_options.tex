% $Id: ESMF_options.tex,v 1.15 2005/08/17 17:32:19 nscollins Exp $
...
{\sf DESCRIPTION:\\}
Supported ESMF data kinds.   These are an 
ESMF derived type used for arguments to subroutines and functions
which want to specify a data precision and type.
