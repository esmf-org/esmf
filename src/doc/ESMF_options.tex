...
\item [ESMF\_FILEFORMAT\_GRIDSPEC]  A single tile logically rectangular
  grid file that follows the NetCDF CF convention. It is the same as the {\tt
    ESMF\_FILEFORMAT\_CFGRID} flag.  See section~\ref{sec:fileformat:gridspec} for more detailed description.
