...
I/O subsystems.  ESMF coupling services will facilitate component 
...
on a parallel platform.  The application component is required to exist on 
...
A coupler or gridded component may exist across all DEs in 
