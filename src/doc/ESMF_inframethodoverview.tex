% $Id: ESMF_inframethodoverview.tex,v 1.9 2005/11/08 23:03:45 nscollins Exp $
...
\scalebox{0.5}{\includegraphics{Basic_xpacket.eps}}
\end{figure}
\end{center}
...
packs data across all blocks as specified by the other
...
\scalebox{0.5}{\includegraphics{Basic_xpacket_pack.eps}}
\end{figure}
\end{center}
...
\scalebox{0.5}{\includegraphics{Basic_xpacket_2up.eps}}
\end{figure}
\end{center}
...
\scalebox{0.5}{\includegraphics{Basic_xpacket_contig.eps}}
\end{figure}
\end{center}

\begin{center}
\begin{figure}
\caption{Generally the overhead of making multiple communication calls 
...
\label{fig:routepack}
\scalebox{0.5}{\includegraphics{Basic_pack_route.eps}}
\end{figure}
\end{center}
...
\scalebox{0.5}{\includegraphics{Basic_2up_route.eps}}
\end{figure}
\end{center}
...
bundle code as being "congruent".  At communication store time,
...
In this case, the conservative thing to do is to construct a
separate Route object for each Field, all enclosed in the same
...
run call for each Field and return to the user when all Fields
...
number of unique types of Fields in the Bundle, and all types
