% $Id: ESMF_inframethodoverview.tex,v 1.17 2006/02/07 20:32:50 nscollins Exp $
...
\scalebox{0.5}{\includegraphics{Basic_xpacket_contig}}
\end{figure}
\end{center}

\begin{center}
\begin{figure}
\scalebox{0.5}{\includegraphics{Basic_pack_route}}
