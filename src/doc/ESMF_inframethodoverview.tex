% $Id: ESMF_inframethodoverview.tex,v 1.7 2005/08/23 16:17:44 nscollins Exp $
...
Other than handling multiple base addresses, this is the
same type of packing as {\t By PET}, see \ref{fig:routepackall}.
\item[By PET]
...
\begin{center}
\begin{figure}
\caption{Often the overhead of making a communication call outweighs
the cost of copying non-contiguous data into a contiguous buffer,
