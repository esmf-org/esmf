% $Id: ESMF_testing.tex,v 1.15 2003/11/12 22:49:32 svasquez Exp $
...
\htmladdnormallink{http://www.esmf.ucar.edu}{http://www.esmf.ucar.edu}.  The testing
...
\begin{verbatim}
        gmake [SYSTEM_TEST=NNNNN] system_tests
        gmake [SYSTEM_TEST=NNNNN] system_tests_uni
\end{verbatim}
...
then you use these commands from the directory \begin{verbatim} ~/esmf. \end{verbatim} 
\begin{verbatim}
