% $Id: ESMC_api.tex,v 1.2 2010/10/29 03:54:06 w6ws Exp $
%
...
The structure for each class is stored in a C header file. 
The operations associated with each class are defined are also
...
\item {\tt ESMC\_<Class>Create()} and {\tt ESMF\_<Class>Destroy()}, for creating and 
...
internally consistent.  For example, {\tt ESMC\_FieldValidate()} checks 
...
you to reference an existing C array to an ESMF Array or 
