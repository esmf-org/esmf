% $Id: ESMC_api.tex,v 1.12 2011/07/05 19:54:43 theurich Exp $
%
...
\item {\tt ESMC\_<Class>Create()} and {\tt ESMC\_<Class>Destroy()}, for
creating and destroying objects of ESMC classes that require internal memory
management (- called ESMF deep classes). The {\tt ESMC\_<Class>Create()} method
allocates memory for the class structure itself and for internal variables, and
...
objects of ESMF container classes - such as {\tt ESMC_State} and
{\tt ESMC_FieldBundle}. For example, the {\tt ESMC\_FieldBundleAdd()}
