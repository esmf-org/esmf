...
The purpose of a Gridded Component is to provide the application
with uniform access to computational data, regardless of hardware
platform, memory hierarchy, or data decomposition.
...
The major subobjects of a Gridded Component are Bundles,
Fields, Physical Grids, Distributed Grids, and Data Arrays.
The Physical Grid carries global coordinate information,
