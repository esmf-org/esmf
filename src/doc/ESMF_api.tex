...
define specific {\tt Set<Something>} and {\tt Get<Something>} 
interfaces.
...
items within a class.  For example, the {\tt State_AddField()}
...
internally consistent.  For example, {\tt Field_Validate} checks 
...
\item {\tt ESMF_Initialize} and {\tt ESMF_Finalize} are required 
...
\item {\tt <Type>Comp_Initialize}, {\tt <Type>Comp_Run}, and 
{\tt <Type>Comp_Finalize} are Component methods that are used at the 
