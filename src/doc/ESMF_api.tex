% $Id: ESMF_api.tex,v 1.50 2011/07/05 19:54:43 theurich Exp $
%
...
\item {\tt ESMF\_<Class>Create()} and {\tt ESMF\_<Class>Destroy()}, for
...
objects of ESMF container classes - such as {\tt ESMF_State} and
{\tt ESMF_FieldBundle}. For example, the {\tt ESMF\_FieldBundleAdd()}
