...
{\tt deep2} only affect {\tt deep2}, and any regular aliases created from
{\tt deep2}. However, the {\em name} retrieved from {\tt deep1}, or from any
regular aliases created from {\tt deep1}, is unaffected.
