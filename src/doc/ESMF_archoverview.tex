% $Id: ESMF_archoverview.tex,v 1.1 2003/04/08 16:06:05 cdeluca Exp $
...
\scalebox{0.5}{\includegraphics{esfmwich.eps}}
\end{figure}
...
\scalebox{0.5}{\includegraphics{ESMFprogrammingparadigm.eps}}
\end{figure}
