% $Id: ESMF_archoverview.tex,v 1.8 2003/08/15 23:03:32 cdeluca Exp $
...
\begin{center}
\begin{figure}
\caption{Assembly of multi-component applications in ESMF}
\label{fig:atmOptions}
\scalebox{.9}{\includegraphics{AtmosGridComp.eps}}
\end{figure}
\end{center}
