% $Id: ESMF_RegridWeightGen.tex,v 1.26 2010/12/14 17:11:37 svasquez Exp $
...
into 3D Cartesian coordiantes by setting the {\tt regridScheme} flag to {\tt ESMF\_REGRID\_SCHEME\_FULL3D} by calling 
{\tt ESMF\_FieldRegridStore()}.   The 
{\tt ESMF\_MeshCreate()}~\ref{sec:example:UnstructFromFile} method is used to create an ESMF\_Mesh object, if the 
