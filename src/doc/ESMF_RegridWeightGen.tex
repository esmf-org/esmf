% $Id: ESMF_RegridWeightGen.tex,v 1.35 2011/04/25 15:22:23 rokuingh Exp $
...
This file based regrid weight generation application is parallel. This application is used in the 
...
{\tt ESMF\_FieldRegridStore()} is used to generate the weight table and indices table representing the interpolation matrix. 
...
keywords). The format of this file is the same as that generated by SCRIP. Note that the sequence of the weights in the file can 
