...
regridding by the {\tt lineType} argument. This argument allows the user to select the path of the line which connects
...
cell a destination point should be mapped. ESMF currently supports two line types: Cartesian and great circle.
