...
\htmladdnormallink{esmf\_support@list.woc.noaa.gov}{mailto:esmf_support@list.woc.noaa.gov}.  
...
\htmladdnormallink{{\it ESMF Developer's Guide}}{http://www.earthsystemmodeling.org/documents/dev_guide} 
