...
\begin{verbatim}
    subroutine f_ESMF_SomeProcedure (a, b_size, b, rc)
      implicit none
...
\begin{verbatim}
extern "C" {
    FTN_X(f_esmf_someprocedure)(float &a, int &b_size, float &b, int &rc);
}
...
    int b_size = 0;
    FTN_X(f_esmf_someprocedure)(&a, &b_size, NULL, &rc);
...
    float *b = new float[20];
    int b_size = 20;
    FTN_X(f_esmf_someprocedure)(&a, &b_size, b, &rc);
\end{verbatim}
