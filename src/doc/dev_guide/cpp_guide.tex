% CVS $Id: cpp_guide.tex,v 1.1 2008/08/29 14:23:30 w6ws Exp $
...
\item The {\tt tr} command is run to convert @ characters to newline
characters.  Secondarily, \^\ characters are converted to \# characters
