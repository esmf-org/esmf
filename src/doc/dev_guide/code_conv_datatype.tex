% CVS $Id: code_conv_datatype.tex,v 1.11 2012/07/18 22:21:54 rokuingh Exp $
...
'hidden' string length arguments after all of the user-supplied arguments.
...
\begin{verbatim}
  void FTN_X(c_esmc_somecode) (
      ...
      string name1_local = string (name1, 0, ESMC_F90lentrim (name1, name1_l));
      string name2_local = string (name2, 0, ESMC_F90lentrim (name2, name2_l));
      ...
  }
\end{verbatim}

Likewise, when C++ code needs to pass a character string to Fortran code,
the string may be simply performed by reference:
