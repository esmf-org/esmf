% CVS $Id: code_conv_datatype.tex,v 1.10 2012/07/17 22:46:22 rokuingh Exp $
...
\begin{verbatim}
         ...
         ...
\end{verbatim}
Likewise in C the enumerated type's name is {\tt ESMC\_TypeKind\_Flag\_Flag\_Flag\_Flag\_Flag}.

The {\tt ESMC\_TypeKind\_Flag\_Flag\_Flag\_Flag\_Flag} parameter names declared are:
\begin{verbatim}
...
In C, {\tt ESMC\_TypeKind\_Flag\_Flag\_Flag\_Flag\_Flag} parameters are used to tailor computation to the type and kind of user data arguments being processed. e.g
\begin{verbatim}
  void FTN_X(c_esmc_vmallfullreduce)(.., ESMC_TypeKind_Flag_Flag_Flag_Flag_Flag *dtk, ..,int *rc){
    .....      
    switch (*dtk){
...
\begin{verbatim}
     ...
     etc.
\end{verbatim}
Also, {\tt ESMF\_TypeKind\_Flag} and {\tt ESMC\_TypeKind\_Flag\_Flag\_Flag\_Flag\_Flag} values are set to have matching values. That is:
\begin{verbatim}
