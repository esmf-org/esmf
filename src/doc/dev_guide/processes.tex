...
to esmf\_test@noaa.gov with the exact subject "Run\_ESMF\_Test\_Build". The mailbox is checked
...
is sent to esmf\_core@list.woc.noaa.gov, with a time stamp in the body of the message.
...
esmf-test@lists.sourceforge.net, esmf\_test@list.woc.noaa.gov.
