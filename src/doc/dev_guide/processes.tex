...
To conserve memory only the backup files for the current year and the prior year will be retained. For years beyond the prior year, retain only 6 month backup files i.e. for 2010 to 2012 of the ESMF cvs files we would have:
