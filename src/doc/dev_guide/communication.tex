%===============================================================================
% CVS $Id: communication.tex,v 1.5 2007/02/13 16:46:04 murphysj Exp $
% CVS $Source: /mnt/twixshare/Storage/Archive-SF-Repos/ESMF_CVS_Repo/esmf/src/doc/dev_guide/communication.tex,v $
% CVS $Name:  $
%===============================================================================
...
The {\bf User Support \& Community} link on the ESMF Web site describes
...
Support \& Community} link on the ESMF Web site.
...
the ESMF Web site.  These telecons are open and are announced to 
...
This site is accessible from the ESMF Web site,
...
\item providing tarballs of public source code releases (releases
      are also made available on the ESMF Web site);
