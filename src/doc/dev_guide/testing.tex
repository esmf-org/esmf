%===============================================================================
% CVS $Id: testing.tex,v 1.14 2008/04/01 15:06:09 donstark Exp $
...
A complete description of the grid configuration files and their syntax is available
in section~\ref{sec:harness} of the developers guide. An equivalent discussion of 
the distribution configuration files is available in section~\ref{sec:harness} of 
