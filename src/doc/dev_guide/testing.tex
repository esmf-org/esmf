%===============================================================================
% CVS $Id: testing.tex,v 1.11 2007/06/27 21:00:08 svasquez Exp $
...
First the unit test must be labled, with one of the following tags:
\begin{itemize}
...
with a logical AND statement when calling ESMF\_Test, but breaking the tests up makes it easier
