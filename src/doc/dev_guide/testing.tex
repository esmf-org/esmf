...
Hovering over the test name i.e. Blues gfortran, will reveal notes particular to that platform/compiler.

The platforms that run the regression tests, email the test results to a server that updates the test results web page. A script checks for test reports every 15 minutes, and updates the web page. The time of the last updated appears on the web page.
