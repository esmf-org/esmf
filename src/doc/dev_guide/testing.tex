%===============================================================================
% CVS $Id: testing.tex,v 1.24 2010/04/19 19:29:26 svasquez Exp $
...
test{tests} directory of each supported class is executed through the run\_unit\_tests target.
