...
\htmladdnormallink{{\it https://www.earthsystemcog.org/projects/esmf/dev_docs/.}}{https://www.earthsystemcog.org/projects/esmf/dev_docs/}

The documents are built daily in the early morning, the results of the builds are posted
\htmladdnormallink{{\it http://www.earthsystemmodeling.org/developers/test/daily/2week_results/trunk_results_noheader/doc_build.shtml.}}{http://www.earthsystemmodeling.org/developers/test/daily/2week_results/trunk_results_noheader/doc_build.shtml}
