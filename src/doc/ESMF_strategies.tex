...
An interface is typically implemented as an array of function pointers.  Components usually have multiple 
...
an application contains multiple address spaces (ASPs).  Calling a 
...
the ASPs in the application.  A component proxy consists of gutted 
...
component-based systems call proxies and 
...
subcomponents.  This
capability is very important to support system scalability.  CCA does it 
...
niceties such as allowing an ORB to automatically generate proxies and stubs.
...
with the reuse
strategy of making components unaware of how they are coupled to
