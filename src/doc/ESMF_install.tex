% $Id: ESMF_install.tex,v 1.70 2008/09/23 01:07:36 w6ws Exp $
...
files have been compiled.  Setting this environment variable forces the library
to be updated after each individual compilation.
...
The -j flag should only be used during the creation of the library.
