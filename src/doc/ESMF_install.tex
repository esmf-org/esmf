...
In the NetCDF 4.2 released in March 2012, the C and Fortran API libraries are released as separate packages.
...
The {\tt ESMF\_NETCDF} environement variable must be set to {\tt "split"}.
