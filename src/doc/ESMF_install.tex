% $Id: ESMF_install.tex,v 1.26 2003/05/30 20:57:52 flanigan Exp $
...
inside an ESMF makefile or build system file.

Here is an example of setting an environment variable in tcsh and csh shells:
\begin{verbatim}
