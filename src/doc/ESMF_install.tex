% $Id: ESMF_install.tex,v 1.93 2010/09/28 03:33:23 eschwab Exp $
...
library. The binary format is supported when MPI\_IO 
...
library.  The following environment variables enable, and specify the name 
and location of the desired XERCES C++ library and associated header files:
