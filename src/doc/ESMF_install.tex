% $Id: ESMF_install.tex,v 1.68 2008/09/19 19:39:37 w6ws Exp $
...
\item[ESMF\_LAPACK] Possible value: "not set", OFF, mkl, netlib, scsl (default depends on system)

\begin{description}
\item["not set"]: ESMF will be compiled with LAPACK LAPACK-dependent features
...
\item[ON]: If set, ESMF\_PNETCDF\_INCLUDE, ESMF\_PNETCDF\_LIBPATH, and
