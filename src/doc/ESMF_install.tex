% $Id: ESMF_install.tex,v 1.29 2003/08/26 17:40:18 flanigan Exp $
...
There are four other environment variables that the build system uses.
...
% GNU make requirement.  File in esmf_build/doc
\input{user_make.tex}
