...
tools will be used to determine the proper settings of the {\tt ESMF\_NETCDF\_LIBS},
{\tt ESMF\_NETCDF\_INCLUDE}, and {\tt ESMF\_NETCDF\_LIBPATH}.  The shell {\tt PATH}
environment variable must specifiy the NetCDF bin directories where nc-config
and nf-config reside.  This option supports having the main NetCDF library and the
