...
clone the {\tt esmf} ESMF code repository (see section \ref{sec:download}.
Latex, latex2html, perl and csh must also be installed. For example,
dependencies may be installed on Ubuntu Linux using:
\begin{verbatim}
