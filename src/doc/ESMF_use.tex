% $Id: ESMF_use.tex,v 1.22 2006/01/09 20:35:25 svasquez Exp $
...
To link a Fortran application to the ESMF libraries please refer 
to the example user makefile, makefile.sample, found in the esmf/build 
directory. This makefile has been tested on all supported platforms. 
