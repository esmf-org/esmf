% $Id: ESMF_use.tex,v 1.11 2003/10/20 23:28:05 svasquez Exp $
...
\noindent{\it Linking using the SGI with 32-bit addressing:} 
...
\noindent{\it Linking using the Linux Lahey Fortran compiler:}
...
\noindent{\it Linking using the Linux Portland Fortran compiler:}
