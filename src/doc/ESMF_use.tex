...
The find file will parse the \textit{esmf.mk} file created following a successful ESMF build. The module sets \textit{esmf.mk} variables as global CMake variables. Please see the find file's docstring for usage instructions.
