! $Id: ESMF_StateReconcileEx.F90,v 1.13 2007/06/22 23:21:50 cdeluca Exp $
!
...
!BOC
    ...
    print *, "InternGridComp Create returned, name = ", trim(comp1name)

    comp2name = "Ocean"
    comp2 = ESMF_InternGridCompCreate(name=comp2name, petList=(/ 2, 3 /), rc=rc)
    print *, "InternGridComp Create returned, name = ", trim(comp2name)
...
!  Then we call ESMF\_InternGridCompInitialize() on all PETs, but the code runs
