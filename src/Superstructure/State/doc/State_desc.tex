% $Id: State_desc.tex,v 1.9 2007/06/23 04:01:08 cdeluca Exp $
%
...
An import State contains data that is necessary for a IGridded Component
or Coupler Component to execute, and an export State contains the data
that a IGridded Component or Coupler Component can make available.
