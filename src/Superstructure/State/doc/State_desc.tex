% $Id: State_desc.tex,v 1.8 2007/06/22 23:21:49 cdeluca Exp $
%
...
An import State contains data that is necessary for a InternGridded Component
or Coupler Component to execute, and an export State contains the data
that a InternGridded Component or Coupler Component can make available.
