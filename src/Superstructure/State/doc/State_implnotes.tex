% $Id: State_implnotes.tex,v 1.4 2005/12/13 23:28:35 nscollins Exp $
%
...
\scalebox{0.66}{\includegraphics{Excl_src_grid}}
\end{figure}
\end{center}
...
\scalebox{0.66}{\includegraphics{Excl_dst_grid}}
\end{figure}
\end{center}
...
in the FieldExcl system test.}
\label{fig:excl_source}
\scalebox{0.66}{\includegraphics{Excl_src_grid_cpl}}
\end{figure}
\end{center}
...
in the FieldExcl system test.}
\label{fig:excl_destination}
\scalebox{0.66}{\includegraphics{Excl_dst_grid_cpl}}
\end{figure}
\end{center}
