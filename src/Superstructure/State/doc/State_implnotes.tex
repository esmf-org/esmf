% $Id: State_implnotes.tex,v 1.10 2007/06/23 04:01:09 cdeluca Exp $
%
...
\begin{center}
\begin{figure}
\scalebox{0.9}{\includegraphics{Excl_src_igrid}}
...
\begin{center}
\begin{figure}
\scalebox{0.9}{\includegraphics{Excl_dst_igrid}}
\caption{The mapping of PETs (processors) to DEs (data)
...
\begin{center}
\begin{figure}
\scalebox{0.9}{\includegraphics{Excl_src_igrid_cpl}}
\caption{The mapping of PETs (processors) to DEs (data)
...
\begin{center}
\begin{figure}
\scalebox{0.9}{\includegraphics{Excl_dst_igrid_cpl}}
\caption{The mapping of PETs (processors) to DEs (data)
