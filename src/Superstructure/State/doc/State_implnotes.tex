% $Id: State_implnotes.tex,v 1.3 2005/08/23 16:39:35 nscollins Exp $
%
...
\scalebox{0.66}{\includegraphics{Excl_src_grid.eps}}
\end{figure}
\end{center}
...
\scalebox{0.66}{\includegraphics{Excl_dst_grid.eps}}
\end{figure}
\end{center}
...
in the FieldExcl system test.}
\label{fig:excl_source}
\scalebox{0.66}{\includegraphics{Excl_src_grid_cpl.eps}}
\end{figure}
\end{center}
...
in the FieldExcl system test.}
\label{fig:excl_destination}
\scalebox{0.66}{\includegraphics{Excl_dst_grid_cpl.eps}}
\end{figure}
\end{center}
