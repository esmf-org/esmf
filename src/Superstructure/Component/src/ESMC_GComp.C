// $Id: ESMC_GComp.C,v 1.1 2003/01/07 21:37:33 nscollins Exp $
//
...
// in the companion file ESMC_GComp.h
//
...
//-----------------------------------------------------------------------------
 ...
 static const char *const version = "$Id: ESMC_GComp.C,v 1.1 2003/01/07 21:37:33 nscollins Exp $";
//-----------------------------------------------------------------------------
...
//      object and uses the internal routine ESMC_GCompContruct to
//      initialize it.  Define for deep classes only, for shallow classes only
//      define and use ESMC_GCompInit.
//      There can be multiple overloaded methods with the same name, but
//      different argument lists.
//
//      Note: this is a class helper function, not a class method
//      (see declaration in ESMC_GComp.h)
//
//EOP
...
//      via an ESMC_GCompCreate routine.  Define for deep classes only.
//
//      Note: this is a class helper function, not a class method
//      (see declaration in ESMC_GComp.h)
//
...
//      as needed.  Must call the corresponding ESMC_GCompDestruct
//      routine to free the additional memory.  Intended for internal
//      ESMF use only; end-users use ESMC_GCompCreate, which calls
//      ESMC_GCompConstruct.  Define for deep classes only.
//
//EOP
// !REQUIREMENTS:  developer's guide for classes
...
//      ESMF_GCompConstruct, does any additional cleanup before the
//      original GComp object is freed.  Intended for internal ESMF
//      use only; end-users use ESMC_GCompDestroy, which calls
//      ESMC_GCompDestruct.  Define for deep classes only.
//
//EOP
// !REQUIREMENTS:  developer's guide for classes
...
//      Construct/Destruct.  Can be overloaded like ESMC_GCompCreate.
//
//EOP
// !REQUIREMENTS:  developer's guide for classes
