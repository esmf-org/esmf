// $Id: ESMCI_FTable.C,v 1.1 2008/08/25 22:04:05 theurich Exp $
//
...
static const char *const version = "$Id: ESMCI_FTable.C,v 1.1 2008/08/25 22:04:05 theurich Exp $";
//-----------------------------------------------------------------------------
