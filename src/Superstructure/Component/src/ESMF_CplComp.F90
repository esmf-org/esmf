! $Id: ESMF_CplComp.F90,v 1.84 2008/02/22 18:07:08 w6ws Exp $
!
...
!
! !INTERFACE:
        subroutine ESMF_CplCompSetEntryPoint (comp, tname, func, phase, status)
...
!
! !INTERFACE:
        subroutine ESMF_CplCompSetServices (Cplcomp, sub, rc)
