// $Id: ESMC_State.C,v 1.1 2003/01/07 21:37:35 nscollins Exp $
//
...
//-----------------------------------------------------------------------------
 ...
 static const char *const version = "$Id: ESMC_State.C,v 1.1 2003/01/07 21:37:35 nscollins Exp $";
//-----------------------------------------------------------------------------
...
//      object and uses the internal routine ESMC_StateContruct to
//      initialize it.  Define for deep classes only, for shallow classes only
//      define and use ESMC_StateInit.
//      There can be multiple overloaded methods with the same name, but
//      different argument lists.
//
//      Note: this is a class helper function, not a class method
//      (see declaration in ESMC_State.h)
//
//EOP
...
//      via an ESMC_StateCreate routine.  Define for deep classes only.
//
//      Note: this is a class helper function, not a class method
//      (see declaration in ESMC_State.h)
//
...
//      as needed.  Must call the corresponding ESMC_StateDestruct
//      routine to free the additional memory.  Intended for internal
//      ESMF use only; end-users use ESMC_StateCreate, which calls
//      ESMC_StateConstruct.  Define for deep classes only.
//
//EOP
// !REQUIREMENTS:  developer's guide for classes
...
//      ESMF_StateConstruct, does any additional cleanup before the
//      original State object is freed.  Intended for internal ESMF
//      use only; end-users use ESMC_StateDestroy, which calls
//      ESMC_StateDestruct.  Define for deep classes only.
//
//EOP
// !REQUIREMENTS:  developer's guide for classes
...
//      Construct/Destruct.  Can be overloaded like ESMC_StateCreate.
//
//EOP
// !REQUIREMENTS:  developer's guide for classes
