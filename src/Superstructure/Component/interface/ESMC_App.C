...
// in the companion file ESMC\_App.h
//
...
//      object and uses the internal routine ESMC\_AppContruct to
//      initialize it.  Define for deep classes only, for shallow classes only
//      define and use ESMC\_AppInit.
//      There can be multiple overloaded methods with the same name, but
//      different argument lists.
//
//      Note: this is a class helper function, not a class method
//      (see declaration in ESMC\_App.h)
//
//EOP
...
//      via an ESMC\_AppCreate routine.  Define for deep classes only.
//
//      Note: this is a class helper function, not a class method
//      (see declaration in ESMC\_App.h)
//
...
//      as needed.  Must call the corresponding ESMC\_AppDestruct
//      routine to free the additional memory.  Intended for internal
//      ESMF use only; end-users use ESMC\_AppCreate, which calls
//      ESMC\_AppConstruct.  Define for deep classes only.
//
//EOP
// !REQUIREMENTS:  developer's guide for classes
...
//      ESMF\_AppConstruct, does any additional cleanup before the
//      original App object is freed.  Intended for internal ESMF
//      use only; end-users use ESMC\_AppDestroy, which calls
//      ESMC\_AppDestruct.  Define for deep classes only.
//
//EOP
// !REQUIREMENTS:  developer's guide for classes
...
//      Construct/Destruct.  Can be overloaded like ESMC\_AppCreate.
//
//EOP
// !REQUIREMENTS:  developer's guide for classes
