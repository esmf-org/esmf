% $Id: CplComp_desc.tex,v 1.6 2007/06/22 23:21:44 cdeluca Exp $
%
...
as InternGridded Components 
(see Section \ref{sec:InternGridComp}).  A Coupler Component, or 
{\tt ESMF\_CplComp}, arranges and executes the data 
transformations between the InternGridded Components.  Ideally, 
Coupler Components should contain all the information 
about inter-component communication for an application.
This enables the InternGridded Components in the application to be 
...
Like InternGridded Components, Coupler Components have two parts, one
...
code necessary for a particular exchange between InternGridded Components.  
...
between InternGridded Components.  ESMF does not currently offer tools 
...
pair of InternGridded Components, or a single Coupler Component can couple 
more than two InternGridded Components.
