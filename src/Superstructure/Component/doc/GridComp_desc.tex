% $Id: GridComp_desc.tex,v 1.3 2004/04/20 18:05:16 cdeluca Exp $
%
...
Gridded Component is as a piece of code representing a particular 
physical domain; for example, an atmospheric model or an ocean model.  
