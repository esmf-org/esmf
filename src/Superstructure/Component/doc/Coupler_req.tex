% $Id: Coupler_req.tex,v 1.4 2007/06/23 04:00:53 cdeluca Exp $
...
\req{IGridded components}

In addition to the general requirements for  a component described in 
\ref{req:compall}, igridded components are required to provide the
following capabilities.

\sreq{IGridded components have one or more associated igrids}
...
\ssreq{Query default igrid}
A igridded component can return its default igrid.
\begin{reqlist}
{\bf Priority:} 2\\
{\bf Source:} GFDL, MIT\\
{\bf Status:} Approved-2.\\
