! $Id: ESMF_AttributeCplCompUTest.F90,v 1.2 2008/08/08 15:25:27 rokuingh Exp $
!
...
!-------------------------------------------------------------------------
    ...
    !-------------------------------------------------------------------------
      ...
      write(name, *) "Adding an ESMF_I4 Attribute to a CplComp Test"
      ...
      write(name, *) "Getting an ESMF_I4 Attribute from a CplComp Test"
      call ESMF_Test((rc==ESMF_SUCCESS).and.(inI4==outI4), &
                      name, failMsg, result, ESMF_SRCLINE)
      !------------------------------------------------------------------------

      !EX_UTest
      ! Destroy an Attribute on a CplComp Test
      call ESMF_AttributeDestroy(cplcomp, name="AttrI4", rc=rc)
      write(failMsg, *) "Did not return ESMF_SUCCESS"
      write(name, *) "Destroying an ESMF_I4 Attribute on a CplComp Test"
      call ESMF_Test((rc==ESMF_SUCCESS), name, failMsg, result, ESMF_SRCLINE)
      !------------------------------------------------------------------------
      ...
      write(failMsg, *) "Did not return ESMF_SUCCESS or wrong value"
      write(name, *) "Getting a default ESMF_I4 Attribute from a CplComp Test"
    ...
    !-------------------------------------------------------------------------
      ...
      call ESMF_AttributeSet(cplcomp, name="AttrI4l", count=count, &
        valueList=inI4l, rc=rc)
      write(failMsg, *) "Did not return ESMF_SUCCESS"
      write(name, *) "Adding an ESMF_I4l Attribute to a CplComp Test"
      call ESMF_Test((rc==ESMF_SUCCESS), name, failMsg, result, ESMF_SRCLINE)
      !------------------------------------------------------------------------

      !EX_UTest
      ! Get an ESMF_I4 list Attribute from a CplComp Test
      call ESMF_AttributeGet(cplcomp, name="AttrI4l", count=count, &
        valueList=outI4l, rc=rc)
      write(failMsg, *) "Did not return ESMF_SUCCESS or wrong value"
      write(name, *) "Getting an ESMF_I4l Attribute from a CplComp Test"
      ...
      !EX_UTest
      ! Destroy an Attribute on a CplComp Test
      call ESMF_AttributeDestroy(cplcomp, name="AttrI4l", rc=rc)
      write(failMsg, *) "Did not return ESMF_SUCCESS"
      write(name, *) "Destroying an ESMF_I4l Attribute on a CplComp Test"
      call ESMF_Test((rc==ESMF_SUCCESS), name, failMsg, result, ESMF_SRCLINE)
      !------------------------------------------------------------------------
      ...
      write(failMsg, *) "Did not return ESMF_SUCCESS or wrong value"
      write(name, *) "Getting a default ESMF_I4l Attribute from a CplComp Test"
    ...
    !-------------------------------------------------------------------------
      ...
      write(failMsg, *) "Did not return ESMF_SUCCESS"
      write(name, *) "Adding an ESMF_I8 Attribute to a CplComp Test"
      call ESMF_Test((rc==ESMF_SUCCESS), name, failMsg, result, ESMF_SRCLINE)
      !------------------------------------------------------------------------
      ...
      write(failMsg, *) "Did not return ESMF_SUCCESS or wrong value"
      write(name, *) "Getting an ESMF_I8 Attribute from a CplComp Test"
      ...
      !EX_UTest
      ! Destroy an Attribute on a CplComp Test
      call ESMF_AttributeDestroy(cplcomp, name="AttrI8", rc=rc)
      write(failMsg, *) "Did not return ESMF_SUCCESS"
      write(name, *) "Destroying an ESMF_I8 Attribute on a CplComp Test"
      call ESMF_Test((rc==ESMF_SUCCESS), name, failMsg, result, ESMF_SRCLINE)
      !------------------------------------------------------------------------
      ...
      write(failMsg, *) "Did not return ESMF_SUCCESS or wrong value"
      write(name, *) "Getting a default ESMF_I8 Attribute from a CplComp Test"
    ...
    !-------------------------------------------------------------------------
      ...
      call ESMF_AttributeSet(cplcomp, name="AttrI8l", count=count, &
        valueList=inI8l, rc=rc)
      write(failMsg, *) "Did not return ESMF_SUCCESS"
      write(name, *) "Adding an ESMF_I8l Attribute to a CplComp Test"
      call ESMF_Test((rc==ESMF_SUCCESS), name, failMsg, result, ESMF_SRCLINE)
      !------------------------------------------------------------------------

      !EX_UTest
      ! Get an ESMF_I8 list Attribute from a CplComp Test
      call ESMF_AttributeGet(cplcomp, name="AttrI8l", count=count, &
        valueList=outI8l, rc=rc)
      write(failMsg, *) "Did not return ESMF_SUCCESS or wrong value"
      write(name, *) "Getting an ESMF_I8l Attribute from a CplComp Test"
      ...
      !EX_UTest
      ! Destroy an Attribute on a CplComp Test
      call ESMF_AttributeDestroy(cplcomp, name="AttrI8l", rc=rc)
      write(failMsg, *) "Did not return ESMF_SUCCESS"
      write(name, *) "Destroying an ESMF_I8l Attribute on a CplComp Test"
      call ESMF_Test((rc==ESMF_SUCCESS), name, failMsg, result, ESMF_SRCLINE)
      !------------------------------------------------------------------------
      ...
      write(failMsg, *) "Did not return ESMF_SUCCESS or wrong value"
      write(name, *) "Getting a default ESMF_I8l Attribute from a CplComp Test"
    ...
    !-------------------------------------------------------------------------
      ...
      write(failMsg, *) "Did not return ESMF_SUCCESS"
      write(name, *) "Adding an ESMF_R4 Attribute to a CplComp Test"
      call ESMF_Test((rc==ESMF_SUCCESS), name, failMsg, result, ESMF_SRCLINE)
      !------------------------------------------------------------------------
      ...
      write(failMsg, *) "Did not return ESMF_SUCCESS or wrong value"
      write(name, *) "Getting an ESMF_R4 Attribute from a CplComp Test"
      ...
      !EX_UTest
      ! Destroy an Attribute on a CplComp Test
      call ESMF_AttributeDestroy(cplcomp, name="AttrR4", rc=rc)
      write(failMsg, *) "Did not return ESMF_SUCCESS"
      write(name, *) "Destroying an ESMF_R4 Attribute on a CplComp Test"
      call ESMF_Test((rc==ESMF_SUCCESS), name, failMsg, result, ESMF_SRCLINE)
      !------------------------------------------------------------------------
      ...
      write(failMsg, *) "Did not return ESMF_SUCCESS or wrong value"
      write(name, *) "Getting a default ESMF_R4 Attribute from a CplComp Test"
    ...
    !-------------------------------------------------------------------------
      ...
      call ESMF_AttributeSet(cplcomp, name="AttrR4l", count=count, &
        valueList=inR4l, rc=rc)
      write(failMsg, *) "Did not return ESMF_SUCCESS"
      write(name, *) "Adding an ESMF_R4l Attribute to a CplComp Test"
      call ESMF_Test((rc==ESMF_SUCCESS), name, failMsg, result, ESMF_SRCLINE)
      !------------------------------------------------------------------------

      !EX_UTest
      ! Get an ESMF_R4 list Attribute from a CplComp Test
      call ESMF_AttributeGet(cplcomp, name="AttrR4l", count=count, &
        valueList=outR4l, rc=rc)
      write(failMsg, *) "Did not return ESMF_SUCCESS or wrong value"
      write(name, *) "Getting an ESMF_R4l Attribute from a CplComp Test"
      ...
      !EX_UTest
      ! Destroy an Attribute on a CplComp Test
      call ESMF_AttributeDestroy(cplcomp, name="AttrR4l", rc=rc)
      write(failMsg, *) "Did not return ESMF_SUCCESS"
      write(name, *) "Destroying an ESMF_R4l Attribute on a CplComp Test"
      call ESMF_Test((rc==ESMF_SUCCESS), name, failMsg, result, ESMF_SRCLINE)
      !------------------------------------------------------------------------
      ...
      write(failMsg, *) "Did not return ESMF_SUCCESS or wrong value"
      write(name, *) "Getting a default ESMF_R4l Attribute from a CplComp Test"
    ...
    !-------------------------------------------------------------------------
      ...
      write(failMsg, *) "Did not return ESMF_SUCCESS"
      write(name, *) "Adding an ESMF_R8 Attribute to a CplComp Test"
      call ESMF_Test((rc==ESMF_SUCCESS), name, failMsg, result, ESMF_SRCLINE)
      !------------------------------------------------------------------------
      ...
      write(failMsg, *) "Did not return ESMF_SUCCESS or wrong value"
      write(name, *) "Getting an ESMF_R8 Attribute from a CplComp Test"
      ...
      !EX_UTest
      ! Destroy an Attribute on a CplComp Test
      call ESMF_AttributeDestroy(cplcomp, name="AttrR8", rc=rc)
      write(failMsg, *) "Did not return ESMF_SUCCESS"
      write(name, *) "Destroying an ESMF_R8 Attribute on a CplComp Test"
      call ESMF_Test((rc==ESMF_SUCCESS), name, failMsg, result, ESMF_SRCLINE)
      !------------------------------------------------------------------------
      ...
      write(failMsg, *) "Did not return ESMF_SUCCESS or wrong value"
      write(name, *) "Getting a default ESMF_R8 Attribute from a CplComp Test"
    ...
    !-------------------------------------------------------------------------
      ...
      call ESMF_AttributeSet(cplcomp, name="AttrR8l", count=count, &
        valueList=inR8l, rc=rc)
      write(failMsg, *) "Did not return ESMF_SUCCESS"
      write(name, *) "Adding an ESMF_R8l Attribute to a CplComp Test"
      call ESMF_Test((rc==ESMF_SUCCESS), name, failMsg, result, ESMF_SRCLINE)
      !------------------------------------------------------------------------

      !EX_UTest
      ! Get an ESMF_R8 list Attribute from a CplComp Test
      call ESMF_AttributeGet(cplcomp, name="AttrR8l", count=count, &
        valueList=outR8l, rc=rc)
      write(failMsg, *) "Did not return ESMF_SUCCESS or wrong value"
      write(name, *) "Getting an ESMF_R8l Attribute from a CplComp Test"
      ...
      !EX_UTest
      ! Destroy an Attribute on a CplComp Test
      call ESMF_AttributeDestroy(cplcomp, name="AttrR8l", rc=rc)
      write(failMsg, *) "Did not return ESMF_SUCCESS"
      write(name, *) "Destroying an ESMF_R8l Attribute on a CplComp Test"
      call ESMF_Test((rc==ESMF_SUCCESS), name, failMsg, result, ESMF_SRCLINE)
      !------------------------------------------------------------------------
      ...
      write(failMsg, *) "Did not return ESMF_SUCCESS or wrong value"
      write(name, *) "Getting a default ESMF_R8l Attribute from a CplComp Test"
    ...
    !-------------------------------------------------------------------------
      ...
      write(failMsg, *) "Did not return ESMF_SUCCESS"
      write(name, *) "Adding a char Attribute to a CplComp Test"
      call ESMF_Test((rc==ESMF_SUCCESS), name, failMsg, result, ESMF_SRCLINE)
      !------------------------------------------------------------------------
      ...
      write(failMsg, *) "Did not return ESMF_SUCCESS or wrong value"
      write(name, *) "Getting a char Attribute from a CplComp Test"
      ...
      !EX_UTest
      ! Destroy an Attribute on a CplComp Test
      call ESMF_AttributeDestroy(cplcomp, name=attrname, rc=rc)
      write(failMsg, *) "Did not return ESMF_SUCCESS"
      write(name, *) "Destroying a char Attribute on a CplComp Test"
      call ESMF_Test((rc==ESMF_SUCCESS), name, failMsg, result, ESMF_SRCLINE)
      !------------------------------------------------------------------------
      ...
      write(failMsg, *) "Did not return ESMF_SUCCESS or wrong value"
      write(name, *) "Getting a default char Attribute from a CplComp Test"
    ...
    !-------------------------------------------------------------------------
      ...
      call ESMF_AttributeSet(cplcomp, name="Charl", count=count, &
        valueList=InCharl, rc=rc)
      write(failMsg, *) "Did not return ESMF_SUCCESS"
      write(name, *) "Setting an Attribute char list on a CplComp test"
      call ESMF_Test((rc==ESMF_SUCCESS), name, failMsg, result, ESMF_SRCLINE)
      !------------------------------------------------------------------------
  
      !EX_UTest
      ! Get a char list Attribute on a CplComp Test
      call ESMF_AttributeGet(cplcomp, name="Charl", count=count, &
        valueList=OutCharl, rc=rc)
      write(failMsg, *) "Did not return ESMF_SUCCESS"
      write(name, *) "Getting an Attribute char list from a CplComp test"
      ...
      !EX_UTest
      ! Destroy an Attribute on a CplComp Test
      call ESMF_AttributeDestroy(cplcomp, name="Charl", rc=rc)
      write(failMsg, *) "Did not return ESMF_SUCCESS"
      write(name, *) "Destroying a Character list Attribute on a CplComp Test"
      call ESMF_Test((rc==ESMF_SUCCESS), name, failMsg, result, ESMF_SRCLINE)
      !------------------------------------------------------------------------

      !EX_UTest
      ! Destroy an Attribute on a CplComp Test, again
      call ESMF_AttributeDestroy(cplcomp, name="Charl", rc=rc)
      write(failMsg, *) "Did not return ESMF_SUCCESS"
      write(name, *) "Destroying a Character list Attribute on a CplComp Test, again"
      call ESMF_Test((rc/=ESMF_SUCCESS), name, failMsg, result, ESMF_SRCLINE)
      !------------------------------------------------------------------------
      ...
      write(failMsg, *) "Did not return ESMF_SUCCESS"
      write(name, *) "Getting a default Attribute char list from a CplComp test"
    ...
    !-------------------------------------------------------------------------
      ...
      call ESMF_AttributeDestroy(cplcomp, name=attrname, rc=rc)
      write(failMsg, *) "Did not return ESMF_SUCCESS"
      write(name, *) "Destroying a logical Attribute on a CplComp Test"
      call ESMF_Test((rc==ESMF_SUCCESS), name, failMsg, result, ESMF_SRCLINE)
      !------------------------------------------------------------------------
      ...
      write(failMsg, *) "Did not return logical .TRUE."
      write(name, *) "Getting CplComp default Attribute (type Fortran logical scalar)"
    ...
    !-------------------------------------------------------------------------
      ...
      write(failMsg, *) "Did not return ESMF_SUCESS"
      write(name, *) "Setting CplComp Attribute (type Fortran logical cplcomp)"
      call ESMF_Test((rc==ESMF_SUCCESS), name, failMsg, result, ESMF_SRCLINE)
      !------------------------------------------------------------------------
      ...
      write(failMsg, *) "Did not return logical .TRUE."
      write(name, *) "Getting CplComp Attribute (type Fortran logical cplcomp)"
      ...
      call ESMF_AttributeDestroy(cplcomp, name=attrname, rc=rc)
      write(failMsg, *) "Did not return ESMF_SUCCESS"
      write(name, *) "Destroying a logical list Attribute on a CplComp Test"
      call ESMF_Test((rc==ESMF_SUCCESS), name, failMsg, result, ESMF_SRCLINE)
      !------------------------------------------------------------------------
    ...
    !-------------------------------------------------------------------------
      ...
      !EX_UTest
      ! Destroy an Attribute in an Attribute package on a CplComp Test
      call ESMF_AttributeDestroy(cplcomp, name=attrname, convention=conv, purpose=purp, rc=rc)
      write(failMsg, *) "Did not return ESMF_SUCCESS"
      write(name, *) "Destroying an Attribute in an Attribute package on a CplComp Test"
      call ESMF_Test((rc==ESMF_SUCCESS), name, failMsg, result, ESMF_SRCLINE)
      !------------------------------------------------------------------------
      ...
      call ESMF_AttributeWrite(cplcomp, convention=conv, purpose=purp, rc=rc)
      write(failMsg, *) "Did not return ESMF_SUCCESS"
    ...
    !-------------------------------------------------------------------------
      ...
      write(failMsg, *) "Did not return ESMF_SUCCESS"
      write(name, *) "Adding multiple Attributes to a standard Attribute package on a CplComp Test"
      call ESMF_Test((rc==ESMF_SUCCESS), name, failMsg, result, ESMF_SRCLINE)
      !------------------------------------------------------------------------

      !EX_UTest
      ! Set an ESMF_I4 Attribute in an Attribute package on a CplComp Test
      call ESMF_AttributeSet(cplcomp, name="ESMF_I4", value=inI4, &
        convention=conv, purpose=purp, rc=rc)
      write(failMsg, *) "Did not return ESMF_SUCCESS"
      write(name, *) "Setting an ESMF_I4 Attribute in an Attribute package on a CplComp Test"
      call ESMF_Test((rc==ESMF_SUCCESS), name, failMsg, result, ESMF_SRCLINE)
      !------------------------------------------------------------------------

      count = 3
      !EX_UTest
      ! Set an ESMF_I4list Attribute in an Attribute package on a CplComp Test
      call ESMF_AttributeSet(cplcomp, name="ESMF_I4list", count=count, valueList=inI4l, &
        convention=conv, purpose=purp, rc=rc)
      write(failMsg, *) "Did not return ESMF_SUCCESS"
      write(name, *) "Setting an ESMF_I4list Attribute in an Attribute package on a CplComp Test"
      call ESMF_Test((rc==ESMF_SUCCESS), name, failMsg, result, ESMF_SRCLINE)
      !------------------------------------------------------------------------

      !EX_UTest
      ! Set an ESMF_I8 Attribute in an Attribute package on a CplComp Test
      call ESMF_AttributeSet(cplcomp, name="ESMF_I8", value=inI8, &
        convention=conv, purpose=purp, rc=rc)
      write(failMsg, *) "Did not return ESMF_SUCCESS"
      write(name, *) "Setting an ESMF_I8 Attribute in an Attribute package on a CplComp Test"
      call ESMF_Test((rc==ESMF_SUCCESS), name, failMsg, result, ESMF_SRCLINE)
      !------------------------------------------------------------------------

      count = 3
      !EX_UTest
      ! Set an ESMF_I8list Attribute in an Attribute package on a CplComp Test
      call ESMF_AttributeSet(cplcomp, name="ESMF_I8list", count=count, valueList=inI8l, &
        convention=conv, purpose=purp, rc=rc)
      write(failMsg, *) "Did not return ESMF_SUCCESS"
      write(name, *) "Setting an ESMF_I8list Attribute in an Attribute package on a CplComp Test"
      call ESMF_Test((rc==ESMF_SUCCESS), name, failMsg, result, ESMF_SRCLINE)
      !------------------------------------------------------------------------

      !EX_UTest
      ! Set an ESMF_R4 Attribute in an Attribute package on a CplComp Test
      call ESMF_AttributeSet(cplcomp, name="ESMF_R4", value=inR4, &
        convention=conv, purpose=purp, rc=rc)
      write(failMsg, *) "Did not return ESMF_SUCCESS"
      write(name, *) "Setting an ESMF_R4 Attribute in an Attribute package on a CplComp Test"
      call ESMF_Test((rc==ESMF_SUCCESS), name, failMsg, result, ESMF_SRCLINE)
      !------------------------------------------------------------------------

      count = 3
      !EX_UTest
      ! Set an ESMF_R4list Attribute in an Attribute package on a CplComp Test
      call ESMF_AttributeSet(cplcomp, name="ESMF_R4list", count=count, valueList=inR4l, &
        convention=conv, purpose=purp, rc=rc)
      write(failMsg, *) "Did not return ESMF_SUCCESS"
      write(name, *) "Setting an ESMF_R4list Attribute in an Attribute package on a CplComp Test"
      call ESMF_Test((rc==ESMF_SUCCESS), name, failMsg, result, ESMF_SRCLINE)
      !------------------------------------------------------------------------

      !EX_UTest
      ! Set an ESMF_R8 Attribute in an Attribute package on a CplComp Test
      call ESMF_AttributeSet(cplcomp, name="ESMF_R8", value=inR8, &
        convention=conv, purpose=purp, rc=rc)
      write(failMsg, *) "Did not return ESMF_SUCCESS"
      write(name, *) "Setting an ESMF_R8 Attribute in an Attribute package on a CplComp Test"
      call ESMF_Test((rc==ESMF_SUCCESS), name, failMsg, result, ESMF_SRCLINE)
      !------------------------------------------------------------------------

      count = 3
      !EX_UTest
      ! Set an ESMF_R8list Attribute in an Attribute package on a CplComp Test
      call ESMF_AttributeSet(cplcomp, name="ESMF_R8list", count=count, valueList=inR8l, &
        convention=conv, purpose=purp, rc=rc)
      write(failMsg, *) "Did not return ESMF_SUCCESS"
      write(name, *) "Setting an ESMF_R8list Attribute in an Attribute package on a CplComp Test"
      call ESMF_Test((rc==ESMF_SUCCESS), name, failMsg, result, ESMF_SRCLINE)
      !------------------------------------------------------------------------

      !EX_UTest
      ! Set an ESMF_R8 Attribute in an Attribute package on a CplComp Test
      call ESMF_AttributeSet(cplcomp, name="Character_", value=attrvalue, &
        convention=conv, purpose=purp, rc=rc)
      write(failMsg, *) "Did not return ESMF_SUCCESS"
      ...
      !EX_UTest
      ! Destroy an Attribute in an Attribute package on a CplComp Test, again
      call ESMF_AttributeDestroy(cplcomp, name=attrname, convention=conv, purpose=purp, rc=rc)
      write(failMsg, *) "Did not return ESMF_SUCCESS"
      write(name, *) "Destroying an Attribute in an Attribute package on a CplComp Test, again"
      call ESMF_Test((rc/=ESMF_SUCCESS), name, failMsg, result, ESMF_SRCLINE)
      !------------------------------------------------------------------------
    ...
    !-------------------------------------------------------------------------
      ...
      write(failMsg, *) "Did not return ESMF_SUCCESS or wrong value"
      write(name, *) "Getting the Attribute count from a CplComp Test"
      ...
      call ESMF_AttributeGet(cplcomp, name=attrname, typekind=attrTK, &
        count=items, rc=rc)
      write(failMsg, *) "Did not return ESMF_SUCCESS or wrong value"
      write(name, *) "Getting Attribute info by name from a CplComp Test"
      ...
      write(failMsg, *) "Did not return ESMF_SUCCESS or wrong value"
      write(name, *) "Getting Attribute info by num from a CplComp Test"
