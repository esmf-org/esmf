! $Id: ESMF_AttributeGridCompUTest.F90,v 1.1 2008/08/01 19:24:20 rokuingh Exp $
!
...
!=========================================================================
      ...
      type(ESMF_GridComp)    :: grdcomp, gfg
      type(ESMF_State)       :: sfg
...
!-------------------------------------------------------------------------
      ...
      call ESMF_AttributeSet(grdcomp, name="Sides", value=inval, rc=rc)
      ...
      call ESMF_AttributeGet(grdcomp, name="Sides", value=outval, rc=rc)
      ...
      call ESMF_AttributeGet(grdcomp, name="NotSides", value=defout, &
      ...
      !EX_UTest
      ! Get an integer attribute from a GridComp Test
      call ESMF_AttributeGet(grdcomp, name="Sides", count=count, rc=rc)
      write(failMsg, *) "Did not return ESMF_SUCCESS or wrong value"
      ...
      call ESMF_AttributeSet(grdcomp, name="list", count=count, &
        valueList=attrListIn, rc=rc)
      write(failMsg, *) "Did not return ESMF_SUCCESS"
      write(name, *) "Setting an Attribute character list on an GridComp test"
      call ESMF_Test((rc==ESMF_SUCCESS), name, failMsg, result, ESMF_SRCLINE)
      !------------------------------------------------------------------------
  
      !EX_UTest
      ! Get a char list Attribute on a GridComp Test
      call ESMF_AttributeGet(grdcomp, name="list", count=count, &
        valueList=attrListOut1, rc=rc)
      write(failMsg, *) "Did not return ESMF_SUCCESS"
      write(name, *) "Getting an Attribute character list from an GridComp test"
      ...
      call ESMF_AttributeGet(grdcomp, name="notlist", count=count, &
        valueList=attrListOut1, defaultvalueList=defvalList, rc=rc)
      write(failMsg, *) "Did not return ESMF_SUCCESS"
      write(name, *) "Getting a default Attribute character list from a GridComp test"
      ...
      call ESMF_AttributeSet(grdcomp, name=attrname, count=count, &
        valueList=attrListIn, convention=conv, purpose=purp, rc=rc)
      write(failMsg, *) "Did not return ESMF_SUCCESS"
      write(name, *) "Setting a char list Attribute in an Attpack from a GridComp Test"
      call ESMF_Test((rc==ESMF_SUCCESS), name, failMsg, result, ESMF_SRCLINE)
      !------------------------------------------------------------------------

      !EX_UTest
      ! Get a char list attribute in an attribute package on a GridComp Test
      call ESMF_AttributeGet(grdcomp, name=attrname, count=count, &
        valueList=attrListOut2, convention=conv, purpose=purp, rc=rc)
      write(failMsg, *) "Did not return ESMF_SUCCESS"
      write(name, *) "Getting a char list Attribute in an Attpack from a GridComp Test"
      ...
      call ESMF_AttributeGet(grdcomp, name="notlist", count=count, &
        ...
        convention=conv, purpose=purp, rc=rc)
      write(failMsg, *) "Did not return ESMF_SUCCESS"
      write(name, *) "Getting a default Attribute character list in an Attpack from a GridComp test"
