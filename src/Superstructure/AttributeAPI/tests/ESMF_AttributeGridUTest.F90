! $Id: ESMF_AttributeGridUTest.F90,v 1.38 2012/09/18 23:34:48 rokuingh Exp $
!
...
!-------------------------------------------------------------------------
    ...
    !-------------------------------------------------------------------------
      ...
      write(name, *) "Getting a constant I8 Attribute from a Grid Test - expect FAIL"
    ...
    !-------------------------------------------------------------------------
      ...
      write(failMsg, *) "Did not return ESMC_RC_ATTR_WRONGTYPE"
      write(name, *) "Getting a constant I8 list Attribute from a Grid Test - expect FAIL"
      call ESMF_Test((rc==ESMC_RC_ATTR_WRONGTYPE), &
                      name, failMsg, result, ESMF_SRCLINE)
      !------------------------------------------------------------------------
    ...
    !-------------------------------------------------------------------------
      ...
      write(failMsg, *) "Did not return ESMC_RC_ATTR_WRONGTYPE"
      write(name, *) "Getting a constant R8 Attribute from a Grid Test - expect FAIL"
      call ESMF_Test((rc==ESMC_RC_ATTR_WRONGTYPE), &
                      name, failMsg, result, ESMF_SRCLINE)
      !------------------------------------------------------------------------
