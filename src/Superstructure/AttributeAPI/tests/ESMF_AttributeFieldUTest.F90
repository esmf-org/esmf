! $Id: ESMF_AttributeFieldUTest.F90,v 1.52 2012/09/18 23:34:48 rokuingh Exp $
!
...
!-------------------------------------------------------------------------
    ...
    !-------------------------------------------------------------------------
      ...
      write(name, *) "Adding an empty value character Attribute to a Field Test"
    ...
    !-------------------------------------------------------------------------
      ...
      write(failMsg, *) "Did not return ESMF_SUCCESS"
      write(name, *) "Adding an empty value character Attribute to a Field Test 2"
      call ESMF_Test((rc==ESMF_SUCCESS), name, failMsg, result, ESMF_SRCLINE)
      !------------------------------------------------------------------------
      ...
      call ESMF_AttributeGet(field, name="EmptyValue", value=outEmpty, rc=rc)
      write(failMsg, *) "Did not return ESMF_SUCCESS or wrong value"
      write(name, *) "Getting an empty value character Attribute from a Field Test 2"
    ...
    !-------------------------------------------------------------------------
      ...
      write(failMsg, *) "Did not return ESMF_SUCCESS"
      write(name, *) "Adding a long value character Attribute to a Field Test"
      call ESMF_Test((rc==ESMF_SUCCESS), name, failMsg, result, ESMF_SRCLINE)
      !------------------------------------------------------------------------
    ...
    !-------------------------------------------------------------------------
      ...
      write(failMsg, *) "Did not return ESMF_SUCCESS"
      write(name, *) "Adding an ESMF_I4 Attribute to a Field Test"
      call ESMF_Test((rc==ESMF_SUCCESS), name, failMsg, result, ESMF_SRCLINE)
      !------------------------------------------------------------------------
      ...
      write(failMsg, *) "Did not return ESMF_SUCCESS or wrong value"
      write(name, *) "Getting an ESMF_I4 Attribute from a Field Test"
      ...
      write(failMsg, *) "Did not return ESMF_SUCCESS or wrong value"
      write(name, *) "Getting a default ESMF_I4 Attribute from a Field Test"
    ...
    !-------------------------------------------------------------------------
      ...
      write(failMsg, *) "Did not return ESMF_SUCCESS"
      write(name, *) "Adding a constant I4 Attribute to a Field Test"
      call ESMF_Test((rc==ESMF_SUCCESS), name, failMsg, result, ESMF_SRCLINE)
      !------------------------------------------------------------------------
      ...
      write(failMsg, *) "Did not return ESMF_SUCCESS or wrong value"
      write(name, *) "Getting a constant I4 Attribute from a Field Test"
    ...
    !-------------------------------------------------------------------------
      ...
      write(failMsg, *) "Did not return ESMF_SUCCESS"
      write(name, *) "Adding a constant I4 list Attribute to a Field Test"
      call ESMF_Test((rc==ESMF_SUCCESS), name, failMsg, result, ESMF_SRCLINE)
      !------------------------------------------------------------------------
      ...
      write(failMsg, *) "Did not return ESMF_SUCCESS or wrong value"
      write(name, *) "Getting a constant I4 list Attribute from a Field Test"
    ...
    !-------------------------------------------------------------------------
      ...
      write(failMsg, *) "Did not return ESMF_SUCCESS"
      write(name, *) "Adding an ESMF_I8 Attribute to a Field Test"
      call ESMF_Test((rc==ESMF_SUCCESS), name, failMsg, result, ESMF_SRCLINE)
      !------------------------------------------------------------------------
      ...
      write(failMsg, *) "Did not return ESMF_SUCCESS or wrong value"
      write(name, *) "Getting an ESMF_I8 Attribute from a Field Test"
      ...
      write(failMsg, *) "Did not return ESMF_SUCCESS or wrong value"
      write(name, *) "Getting a default ESMF_I8 Attribute from a Field Test"
    ...
    !-------------------------------------------------------------------------
      ...
      write(failMsg, *) "Did not return ESMF_SUCCESS"
      write(name, *) "Adding a constant I8 Attribute to a Field Test"
      call ESMF_Test((rc==ESMF_SUCCESS), name, failMsg, result, ESMF_SRCLINE)
      !------------------------------------------------------------------------
      ...
      write(name, *) "Getting a constant I8 Attribute from a Field Test - expect FAIL"
    ...
    !-------------------------------------------------------------------------
      ...
      call ESMF_AttributeSet(field, name="ConstantI8l", &
        valueList=(/1,2,3/), rc=rc)
      write(failMsg, *) "Did not return ESMF_SUCCESS"
      write(name, *) "Adding a constant I8 list Attribute to a Field Test"
      call ESMF_Test((rc==ESMF_SUCCESS), name, failMsg, result, ESMF_SRCLINE)
      !------------------------------------------------------------------------
      ...
      write(failMsg, *) "Did not return ESMC_RC_ATTR_WRONGTYPE"
      write(name, *) "Getting a constant I8 list Attribute from a Field Test - expect FAIL"
      call ESMF_Test((rc==ESMC_RC_ATTR_WRONGTYPE), &
                      name, failMsg, result, ESMF_SRCLINE)
      !------------------------------------------------------------------------
    ...
    !-------------------------------------------------------------------------
      ...
      write(failMsg, *) "Did not return ESMF_SUCCESS"
      write(name, *) "Adding an ESMF_R4 Attribute to a Field Test"
      call ESMF_Test((rc==ESMF_SUCCESS), name, failMsg, result, ESMF_SRCLINE)
      !------------------------------------------------------------------------
      ...
      write(failMsg, *) "Did not return ESMF_SUCCESS or wrong value"
      write(name, *) "Getting an ESMF_R4 Attribute from a Field Test"
      ...
      write(failMsg, *) "Did not return ESMF_SUCCESS or wrong value"
      write(name, *) "Getting a default ESMF_R4 Attribute from a Field Test"
    ...
    !-------------------------------------------------------------------------
      ...
      write(failMsg, *) "Did not return ESMF_SUCCESS"
      write(name, *) "Adding a constant R4 Attribute to a Field Test"
      call ESMF_Test((rc==ESMF_SUCCESS), name, failMsg, result, ESMF_SRCLINE)
      !------------------------------------------------------------------------
      ...
      write(failMsg, *) "Did not return ESMF_SUCCESS or wrong value"
      write(name, *) "Getting a constant R4 Attribute from a Field Test"
    ...
    !-------------------------------------------------------------------------
      ...
      write(failMsg, *) "Did not return ESMF_SUCCESS"
      write(name, *) "Adding a constant R4 list Attribute to a Field Test"
      call ESMF_Test((rc==ESMF_SUCCESS), name, failMsg, result, ESMF_SRCLINE)
      !------------------------------------------------------------------------
      ...
      write(failMsg, *) "Did not return ESMF_SUCCESS or wrong value"
      write(name, *) "Getting a constant R4 list Attribute from a Field Test"
    ...
    !-------------------------------------------------------------------------
      ...
      write(failMsg, *) "Did not return ESMF_SUCCESS"
      write(name, *) "Adding an ESMF_R8 Attribute to a Field Test"
      call ESMF_Test((rc==ESMF_SUCCESS), name, failMsg, result, ESMF_SRCLINE)
      !------------------------------------------------------------------------
      ...
      write(failMsg, *) "Did not return ESMF_SUCCESS or wrong value"
      write(name, *) "Getting a default ESMF_R8 Attribute from a Field Test"
    ...
    !-------------------------------------------------------------------------
      ...
      write(failMsg, *) "Did not return ESMF_SUCCESS"
      write(name, *) "Adding a constant R8 Attribute to a Field Test"
      call ESMF_Test((rc==ESMF_SUCCESS), name, failMsg, result, ESMF_SRCLINE)
      !------------------------------------------------------------------------
      ...
      write(failMsg, *) "Did not return ESMC_RC_ATTR_WRONGTYPE"
      write(name, *) "Getting a constant R8 Attribute from a Field Test - expect FAIL"
      call ESMF_Test((rc==ESMC_RC_ATTR_WRONGTYPE), &
                      name, failMsg, result, ESMF_SRCLINE)
      !------------------------------------------------------------------------
    ...
    !-------------------------------------------------------------------------
      ...
      write(failMsg, *) "Did not return ESMF_SUCCESS"
      write(name, *) "Getting a wrong sized default Attribute R8 list from a Field test"
    ...
    !-------------------------------------------------------------------------
      ...
      call ESMF_AttributeSet(field, name="ConstantR8l", &
        valueList=(/1,2,3/), rc=rc)
      write(failMsg, *) "Did not return ESMF_SUCCESS"
      write(name, *) "Adding a constant R8 list Attribute to a Field Test"
      call ESMF_Test((rc==ESMF_SUCCESS), name, failMsg, result, ESMF_SRCLINE)
      !------------------------------------------------------------------------
      ...
      write(failMsg, *) "Did not return ESMC_RC_ATTR_WRONGTYPE"
      write(name, *) "Getting a constant R8 list Attribute from a Field Test"
      call ESMF_Test((rc==ESMC_RC_ATTR_WRONGTYPE), &
                      name, failMsg, result, ESMF_SRCLINE)
      !------------------------------------------------------------------------
    ...
    !-------------------------------------------------------------------------
      ...
      write(failMsg, *) "Did not return ESMF_SUCCESS"
      write(name, *) "Adding a char Attribute to a Field Test"
      call ESMF_Test((rc==ESMF_SUCCESS), name, failMsg, result, ESMF_SRCLINE)
      !------------------------------------------------------------------------
      ...
      write(failMsg, *) "Did not return ESMF_SUCCESS or wrong value"
      write(name, *) "Getting a default char Attribute from a Field Test"
    ...
    !-------------------------------------------------------------------------
      ...
      write(failMsg, *) "Did not return ESMF_SUCCESS"
      write(name, *) "Adding a constant character Attribute to a Field Test"
      call ESMF_Test((rc==ESMF_SUCCESS), name, failMsg, result, ESMF_SRCLINE)
      !------------------------------------------------------------------------
      ...
      write(failMsg, *) "Did not return ESMF_SUCCESS or wrong value"
      write(name, *) "Getting a constant character Attribute from a Field Test"
    ...
    !-------------------------------------------------------------------------
      ...
      write(failMsg, *) "Did not return ESMF_SUCCESS"
      write(name, *) "Adding a constant character list Attribute to a Field Test"
      call ESMF_Test((rc==ESMF_SUCCESS), name, failMsg, result, ESMF_SRCLINE)
      !------------------------------------------------------------------------
      ...
      write(failMsg, *) "Did not return ESMF_SUCCESS or wrong value"
      write(name, *) "Getting a constant character list Attribute from a Field Test"
      call ESMF_Test((rc==ESMF_SUCCESS).and. &
    ...
    !-------------------------------------------------------------------------
      ...
      write(failMsg, *) "Did not return logical .TRUE."
      write(name, *) "Getting Field default Attribute (type Fortran logical scalar)"
    ...
    !-------------------------------------------------------------------------
      ...
      write(failMsg, *) "Did not return ESMF_SUCCESS"
      write(name, *) "Adding a constant Logical Attribute to a Field Test"
      call ESMF_Test((rc==ESMF_SUCCESS), name, failMsg, result, ESMF_SRCLINE)
      !------------------------------------------------------------------------
      ...
      write(failMsg, *) "Did not return ESMF_SUCCESS or wrong value"
      write(name, *) "Getting a constant Logical Attribute from a Field Test"
    ...
    !-------------------------------------------------------------------------
      ...
      write(failMsg, *) "Did not return ESMF_SUCCESS"
      write(name, *) "Getting a wrong sized default Attribute logical list from a Field test"
      call ESMF_Test((rc==ESMF_SUCCESS) .and. &
    ...
    !-------------------------------------------------------------------------
      ...
      write(failMsg, *) "Did not return ESMF_SUCCESS"
      write(name, *) "Adding a constant Logical list Attribute to a Field Test"
      call ESMF_Test((rc==ESMF_SUCCESS), name, failMsg, result, ESMF_SRCLINE)
      !------------------------------------------------------------------------
      ...
      write(failMsg, *) "Did not return ESMF_SUCCESS or wrong value"
      write(name, *) "Getting a constant Logical list Attribute from a Field Test"
      call ESMF_Test((rc==ESMF_SUCCESS).and. &
    ...
    !-------------------------------------------------------------------------
      ...
      write(name, *) "Getting an ESMF_R8l Attribute from a Field Test with short valueList"
      call ESMF_Test(rc/=ESMF_SUCCESS, name, failMsg, result, ESMF_SRCLINE)
      !------------------------------------------------------------------------
      ...
      write(failMsg, *) "Did not return ESMF_RC_ATTR_ITEMSOFF"
      write(name, *) "Getting an Attribute char list from a Field test with short valueList"
      call ESMF_Test((rc/=ESMF_SUCCESS), name, failMsg, result, ESMF_SRCLINE)
      !------------------------------------------------------------------------
    ...
    !-------------------------------------------------------------------------
      ...
      call ESMF_AttributeSet(field, name=attrname, &
        valueList=inLogl, rc=rc)
      write(failMsg, *) "Did not return ESMF_SUCESS"
      write(name, *) "Setting an Attribute logical list on a Field test"
      call ESMF_Test((rc==ESMF_SUCCESS), name, failMsg, result, ESMF_SRCLINE)
      !------------------------------------------------------------------------
      ...
      write(name, *) "Getting an logical list Attribute from a Field Test with short valueList"
    ...
    !-------------------------------------------------------------------------
      ...
      call ESMF_AttributeSet(field, name=attrname, value=attrvalue, &
        convention=conv, purpose=purp, rc=rc)
      write(failMsg, *) "Did not return ESMF_SUCCESS"
      write(name, *) "Setting an Attribute in an Attribute package on a Field Test"
      call ESMF_Test((rc==ESMF_SUCCESS), name, failMsg, result, ESMF_SRCLINE)
      !------------------------------------------------------------------------
      ...
      !EX_UTest
      ! Remove the entire Attribute package from a Field Test
      call ESMF_AttributeRemove(field, convention=conv, purpose=purp, rc=rc)
      write(failMsg, *) "Did not return ESMF_SUCCESS"
      write(name, *) "Removing the entire Attribute package from a Field Test"
      call ESMF_Test((rc==ESMF_SUCCESS), name, failMsg, result, ESMF_SRCLINE)
      !------------------------------------------------------------------------
    ...
    !-------------------------------------------------------------------------
      ...
      !NEX_UTest
      ! Set an Attribute in an Attribute package on a Field Test
      call ESMF_AttributeSet(field, name="Intent", value="Export", &
        convention=conv, purpose=purp, rc=rc)
      write(failMsg, *) "Did not return ESMF_SUCCESS"
      write(name, *) "Setting an Attribute in an Attribute package on a Field Test 2"
      call ESMF_Test((rc==ESMF_SUCCESS), name, failMsg, result, ESMF_SRCLINE)
      !------------------------------------------------------------------------
    ...
    !-------------------------------------------------------------------------
      ...
      write(failMsg, *) "Did not return ESMF_SUCCESS or wrong value"
      write(name, *) "Getting the Attribute count from a Field Test"
      ...
      write(failMsg, *) "Did not return ESMF_SUCCESS or wrong value"
      write(name, *) "Getting Attribute info by name with typekind and itemCount from a Field Test"
      call ESMF_Test((rc==ESMF_SUCCESS) &
                     .and. (attrTK==ESMF_NOKIND) &
                     .and. (items==0), &
                     name, failMsg, result, ESMF_SRCLINE)
