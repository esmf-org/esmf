...
!-------------------------------------------------------------------------
    ...
    !-------------------------------------------------------------------------
      ...
      attpack = ESMF_AttributeAdd(gridcomp, convention=conv, &
    ...
    !-------------------------------------------------------------------------
      ...
      attpack = ESMF_AttributeAdd(gridcomp, convention=conv, purpose=purp, rc=rc)
      write(failMsg, *) "Did not return ESMF_SUCCESS"
    ...
    !-------------------------------------------------------------------------
      ...
      attpack = ESMF_AttributeAdd(gridcomp, convention=nestconv, purpose=nestpurp, &
