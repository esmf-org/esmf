% $Id: AppDriver_usage.tex,v 1.11 2007/06/23 04:00:51 cdeluca Exp $
%
...
top-level IGridded Component.  This provides a simple, clear sequence
of operations at the highest level, and also enables the entire 
application to be treated as a sub-IGridded Component of another, larger 
