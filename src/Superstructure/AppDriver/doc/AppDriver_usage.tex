% $Id: AppDriver_usage.tex,v 1.10 2007/06/22 23:21:43 cdeluca Exp $
%
...
top-level InternGridded Component.  This provides a simple, clear sequence
of operations at the highest level, and also enables the entire 
application to be treated as a sub-InternGridded Component of another, larger 
