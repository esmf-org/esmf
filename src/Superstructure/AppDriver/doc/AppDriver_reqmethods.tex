% $Id: AppDriver_reqmethods.tex,v 1.7 2007/06/22 23:21:43 cdeluca Exp $
%
...
{\tt ESMF\_<InternGrid/Cpl>CompSetEntryPoint()} should be called for
...
{\tt ESMF\_<InternGrid|Cpl>CompSetInternalState} method.
...
will first call {\tt ESMF\_<InternGrid/Cpl>CompCreate()} to create an "empty" 
...
each component.  See Sections \ref{sec:InternGridSetServ} and \ref{sec:CplSetServ}
