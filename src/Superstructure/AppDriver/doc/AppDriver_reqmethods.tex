% $Id: AppDriver_reqmethods.tex,v 1.8 2007/06/23 04:00:50 cdeluca Exp $
%
...
{\tt ESMF\_<IGrid/Cpl>CompSetEntryPoint()} should be called for
...
{\tt ESMF\_<IGrid|Cpl>CompSetInternalState} method.
...
will first call {\tt ESMF\_<IGrid/Cpl>CompCreate()} to create an "empty" 
...
each component.  See Sections \ref{sec:IGridSetServ} and \ref{sec:CplSetServ}
