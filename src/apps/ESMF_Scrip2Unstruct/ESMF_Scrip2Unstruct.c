...
//
//==============================================================================
// convert a 2D grid file (either structured or unstructured) in SCRIP format NetCDF file 
// into a ESMF unstructured file format or a UGRID file format.
// A dual mesh is generated by mapping the center coordinates into nodes if the dualflag
// is set to 1.
