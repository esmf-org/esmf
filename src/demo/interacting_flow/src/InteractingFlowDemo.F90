...
!
    ...
    ! Public entry point
    public InteractingFlow_register
...
!------------------------------------------------------------------------------
!BOPI
! !IROUTINE: InteractingFlow_register - Externally visible registration routine

! !INTERFACE:
      subroutine InteractingFlow_register(comp, rc)
!
! !ARGUMENTS:
...
!\begin{verbatim}
        ...
        call ESMF_GridCompSetEntryPoint(comp, ESMF_SETINIT, &
                                        interactingflow_init, ESMF_SINGLEPHASE, rc)
        call ESMF_GridCompSetEntryPoint(comp, ESMF_SETRUN, &
                                        interactingflow_run, ESMF_SINGLEPHASE, rc)
        call ESMF_GridCompSetEntryPoint(comp, ESMF_SETFINAL, &
                                        interactingflow_final, ESMF_SINGLEPHASE, rc)

!\end{verbatim}
!EOP
        print *, "InteractingFlowDemo: Registered Initialize, Run, and Finalize routines"

    end subroutine

!------------------------------------------------------------------------------
!BOPI
! !IROUTINE: interactingflow_init - initialization routine

! !INTERFACE:
      subroutine interactingflow_init(gcomp, importState, exportState, clock, rc)
!
! !ARGUMENTS:
...
!------------------------------------------------------------------------------
    ...
    !
    call ESMF_GridGet(gridTop, horzRelLoc=ESMF_CELL_CENTER, &
...
!EOP
    ...
    end subroutine interactingflow_init

!------------------------------------------------------------------------------
!BOPI
! !IROUTINE: interactingflow_run - run routine

! !INTERFACE:
      subroutine interactingflow_run(comp, importState, exportState, clock, rc)
!
! !ARGUMENTS:
     type(ESMF_GridComp), intent(inout) :: comp
     type(ESMF_State), intent(inout) :: importState, exportState
...
!------------------------------------------------------------------------------
!BOPI
! !IROUTINE:  interactingflow_final - user supplied finalize routine

! !INTERFACE:
      subroutine interactingflow_final(comp, importState, exportState, clock, rc)
!
! !ARGUMENTS:
     type(ESMF_GridComp), intent(inout) :: comp
     type(ESMF_State), intent(inout) :: importState, exportState
...
!EOPI
      ...
      print *, "InteractingFlowMod finished calling all subcomponent Finalize routines"
      ...
      print *, "end of InteractingFlowMod Finalization routine"
      rc = ESMF_SUCCESS

    end subroutine interactingflow_final


    end module InteractingFlowMod
